...
- [知识索引与知识模块（Knowledge / Index & Knowledge）](knowledge-indexing.md) - 四知识源（CodeGraph/OpenWiki/AGENTS/架构图）的聚合状态、BuildJobManager 后台构建（R3-5 分阶段可观测）、知识 tab 四个子页签、符号关系图（R3-6）与架构图 Mermaid 化产物格式。
