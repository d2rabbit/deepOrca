...
- [知识构建（CodeGraph → OpenWiki → AGENTS → archmap）](knowledge-build.md) - 一键构建串行流水线：BuildJobManager 驱动 core action 依次完成 CodeGraph 索引、OpenWiki 文档、AGENTS 就位与架构图扫描，含失败降级。
