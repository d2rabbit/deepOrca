...
export const OPENUI_LIBRARY_SCHEMA: Record<string, unknown> = {
  ...
  $defs: {
    ...
    MarkDownRenderer: {
      ...
      properties: {
        ...
        variant: {
          type: "string",
          enum: ["clear", "card", "sunk"],
        },
      },
      required: ["textMarkdown"],
      additionalProperties: false,
    ...
    TextCallout: {
      ...
      properties: {
        variant: {
          type: "string",
          enum: ["neutral", "info", "warning", "success", "danger"],
        },
        title: {
          type: "string",
        },
    ...
    Input: {
      ...
      properties: {
        ...
        type: {
          type: "string",
          enum: ["text", "email", "password", "number", "url"],
        },
        rules: {
          type: "object",
          properties: {
    ...
    CheckBoxItem: {
      ...
      required: ["label", "description", "name"],
      additionalProperties: false,
    },
    RadioGroup: {
      type: "object",
