...
const CHANGELOG: { version: string; date: string; changes: string[]; en: string[] }[] = [
  ...
  },
  {
    ...
    date: "2026-09",
    changes: [
      "模型引擎:多端点模型舰队收官适配,新增实验性 AI SDK 传输通道(默认关闭,设置可开);开源模型规格库 models.dev 驱动模型登记建议、能力预填与费用估算(含缓存折扣档);GLM/Kimi/MiniMax/Qwen 等兼容系列经统一路径接入。",
      "编辑器域:内核迁移至 CodeMirror 6,新增 AI 结对画布与编辑器智能体数字体(选中即问,支持一键取消),LSP 裸帧中继带来类型级诊断反馈。",
      "任务树:工作区统一任务树——会话、索引构建、代码审查、原型设计并入一棵树,支持分支 fork、谱系追溯与归档。",
      "记忆管线:提取端点凭证修复(拆分端点不再静默 404)、思考信封对齐(思考型副模型不再烧尽输出预算)与配置热重载(改模型/密钥即生效,无需重启)。",
      "UI-Design:LeaferJS 画布引擎与 clay 布局运行时(.ddu 自包含交互导出与离线预览);PM-Design 三段页签(需求文档→交互原型→验收报告)。",
      "会话与界面现代化重设计落地;开源致谢补齐 12 项生态项目,本地化六语言全量更新。",
    ],
    en: [
      "Model engine: multi-endpoint fleet adaptation finalized, plus an experimental AI SDK transport channel (off by default, opt-in via settings); the open models.dev catalog powers model-picker suggestions, capability prefill and cost estimates (cache-discount tier included); GLM/Kimi/MiniMax/Qwen-class compatible series onboarded through one unified path.",
      "Editor domain: kernel migrated to CodeMirror 6; new AI pair canvas and the editor digital entity (ask-on-selection, cancellable mid-run); LSP bare-frame relay delivers type-level diagnostics.",
      "Task tree: one unified workspace tree — sessions, index builds, code reviews and prototype designs merge into a single tree with branch forks, lineage tracing and archiving.",
      "Memory pipeline: extraction endpoint-credential fix (split endpoints no longer fail silent 404s), thinking-envelope alignment (thinking-default secondaries no longer burn the output budget) and config hot-reload (model/key changes take effect without restart).",
      "UI-Design: LeaferJS canvas engine and the clay layout runtime (.ddu self-contained interactive export & offline preview); PM-Design three-stage tabs (requirement doc → interactive prototype → acceptance report).",
      "Modernized session & UI redesign landed; open-source acknowledgements grew by 12 ecosystem projects; all six locales fully updated.",
    ],
  },
];
...
const OPEN_SOURCE_CREDITS: Array<{ name: string; zh: string; en: string; license: string; url?: string }> = [
  ...
  {
    name: "Vercel AI SDK",
    zh: "实验性 LLM 传输通道(ai + @ai-sdk/openai-compatible,默认关闭,设置可开)。",
    en: "Experimental LLM transport channel (ai + @ai-sdk/openai-compatible; off by default, opt-in via settings).",
    license: "Apache-2.0",
    url: "https://github.com/vercel/ai",
  },
  {
    name: "models.dev",
    zh: "开源模型规格目录 —— 220+ 供应商的模型能力/上下文窗口/价格数据,驱动模型登记建议、能力预填与费用估算。",
    en: "Open model-spec catalog — capability/context-window/pricing data for 220+ providers, powering model-picker suggestions, capability prefill and cost estimates.",
    license: "MIT",
    url: "https://github.com/anomalyco/models.dev",
  },
  {
    name: "CodeMirror 6",
    zh: "代码编辑器内核(语法高亮/LSP 集成/智能补全)。",
    en: "Code editor kernel (syntax highlighting / LSP integration / autocompletion).",
    license: "MIT",
    url: "https://github.com/codemirror/dev",
  },
  {
    name: "LeaferJS",
    zh: "UI-Design 画布引擎(leafer-editor 创作与渲染)。",
    en: "UI-Design canvas engine (leafer-editor authoring & rendering).",
    license: "MIT",
    url: "https://github.com/leaferjs/leafer-editor",
  },
  {
    name: "clay",
    zh: "C 布局引擎 —— .ddu 交互导出的自包含 HTML 预览运行时。",
    en: "C layout engine — the self-contained HTML preview runtime for .ddu interactive exports.",
    license: "Zlib",
    url: "https://github.com/nicbarker/clay",
  },
  {
    name: "Tailwind / NameThatUI",
    zh: "DeepDesign 离线 JIT 样式引擎 + 14 套风格库。",
    en: "Offline-JIT styling engine for DeepDesign + the 14-style NameThatUI library.",
    license: "MIT",
    url: "https://github.com/tailwindlabs/tailwindcss",
  },
  {
    name: "awesome-design-md",
    zh: "70+ 品牌 DESIGN.md 设计系统库(awesome-design-md)。",
    en: "70+ brand DESIGN.md design-system library (awesome-design-md).",
    license: "MIT",
    url: "https://github.com/VoltAgent/awesome-design-md",
  },
  {
    name: "Motion",
    zh: "界面动效编排(进出场/布局/级联动画)。",
    en: "Interface motion orchestration (enter/exit, layout and cascading animations).",
    license: "MIT",
    url: "https://github.com/motiondivision/motion",
  },
  {
    name: "Marp",
    zh: "需求文档幻灯片导出(marp-core)。",
    en: "Requirement-doc slide export (marp-core).",
    license: "MIT",
    url: "https://github.com/marp-team/marp-core",
  },
  {
    name: "open-file-viewer",
    zh: "编辑器二进制文件预览(PDF/Office/图像/压缩包兜底)。",
    en: "Editor binary-file preview (PDF / Office / image / archive fallback).",
    license: "MIT",
    url: "https://github.com/xushanpei/open-file-viewer",
  },
  {
    name: "A2UI",
    zh: "Agent-to-UI 全域动态交互协议层。",
    en: "The Agent-to-UI dynamic interaction layer.",
    license: "Apache-2.0",
