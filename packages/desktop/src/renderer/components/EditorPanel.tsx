...
import { DirIcon, FileIcon, IconButton, IconFile, IconFolder } from "../ui/index";
            ...
            >
              <span className={`ui-editor-file-icon${entry.type === "directory" ? " is-dir" : ""}`}>
                {entry.type === "directory" ? (
                  <DirIcon name={entry.name} fallback={<IconFolder />} />
                ) : (
                  <FileIcon name={entry.name} fallback={<IconFile />} />
                )}
              </span>
