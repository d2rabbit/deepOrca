...
export const en = {
  ...
  "index.source.memory": "Memory",
  "index.source.routing": "Routing",
  "index.state.empty": "Empty",
  "index.state.disabled": "Disabled",
  "index.state.stale": "May be stale",
  "index.rebuild": "Rebuild",
  "index.enable": "Enable",
  "index.memory.l0": "Conversations",
  "index.memory.l1": "Facts",
  "index.memory.l2": "Scenes",
  "index.memory.l3": "Persona",
  "index.memory.searchPlaceholder": "Search memories…",
  "index.memory.noResults": "No matching memories",
  "index.memory.clear": "Clear All",
  "index.memory.clearConfirm": "Delete all stored memories (L0-L3) for this project? This cannot be undone.",
  ...
  "review.drift.title": "Brand drift gate",
  "review.drift.hint": "Deterministic 0–100 drift vs the brand baseline (dembrandt --compare, zero LLM).",
  "review.drift.baseline": "Baseline JSON path or URL",
  "review.drift.current": "Current site URL or local file",
  "review.drift.run": "Run drift gate",
  "review.drift.detected": "Drift detected",
  "review.drift.pass": "Within baseline",
  "review.drift.score": "score {score}",
  "review.drift.details": "Per-token findings",
...
export const zh: Record<MessageKey, string> = {
  ...
  "index.source.serena": "Serena",
  "index.source.agents": "AGENTS.md",
  "index.source.memory": "记忆",
  "index.source.routing": "语义路由",
  "index.state.empty": "空",
  "index.state.disabled": "未启用",
  "index.state.stale": "可能过期",
  "index.rebuild": "重建",
  "index.enable": "启用",
  "index.memory.l0": "原始对话",
  "index.memory.l1": "原子事实",
  "index.memory.l2": "场景片段",
  "index.memory.l3": "用户画像",
  "index.memory.searchPlaceholder": "搜索记忆…",
  "index.memory.noResults": "无匹配记忆",
  "index.memory.clear": "清除全部",
  "index.memory.clearConfirm": "删除此项目的所有记忆（L0-L3）？此操作不可撤销。",
  ...
  "review.drift.title": "品牌漂移闸门",
  "review.drift.hint": "与品牌基线的确定性 0–100 漂移分（dembrandt --compare，零 LLM）。",
  "review.drift.baseline": "基线 JSON 路径或 URL",
  "review.drift.current": "当前站点 URL 或本地文件",
  "review.drift.run": "运行漂移检测",
  "review.drift.detected": "检测到漂移",
  "review.drift.pass": "基线内",
  "review.drift.score": "漂移分 {score}",
  "review.drift.details": "逐 token 明细",
