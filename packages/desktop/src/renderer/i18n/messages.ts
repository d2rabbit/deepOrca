...
export const en = {
  ...
  "builtin-plugin.code-intelligence.name": "Code Intelligence",
  ...
  "builtin-plugin.android-dev.desc": "Official Google Android dev skills (20) + Android CLI.",
  "builtin-plugin.harmonyos-dev.name": "HarmonyOS Development",
  "builtin-plugin.harmonyos-dev.desc": "HarmonyOS dev skills + DevEco CLI MCP.",
  "builtin-plugin.expo-dev.name": "Expo Development",
  "builtin-plugin.expo-dev.desc": "Expo/RN dev skills + Expo MCP. From expo/skills.",
  "builtin-plugin.dotnet-dev.name": ".NET Development",
  "builtin-plugin.dotnet-dev.desc": "Microsoft official .NET skills (96). Cross-platform. From dotnet/skills.",
  "builtin-plugin.qt-dev.name": "Qt/KDE Development",
  "builtin-plugin.qt-dev.desc": "Qt Group official skills (12). Cross-platform. From TheQtCompanyRnD/agent-skills.",
  "builtin-plugin.apple-dev.name": "Apple Platform Development",
  "builtin-plugin.apple-dev.desc":
    "Apple Xcode 27 first-party skills + community. macOS only (requires Xcode 27 + xcrun).",
  "builtin-plugin.deepin-dev.name": "deepin/UOS Development",
  "builtin-plugin.deepin-dev.desc": "Official deepin desktop dev skills. Linux only. From linuxdeepin/deepin-skills.",
  "builtin-plugin.design.name": "Design Generation",
  "builtin-plugin.design.desc": "DeepDesign + PM-Designer + taste design discipline.",
  "builtin-plugin.documentation.name": "Knowledge & Docs",
  "builtin-plugin.documentation.desc": "GitMCP + OpenWiki + behavioral memory (activity-frames).",
  ...
  "builtin-plugin.security.name": "Security",
  "builtin-plugin.security.desc": "SkillSpector — AI skill/MCP security scanner (68 vulnerability patterns).",
...
export const zh: Record<MessageKey, string> = {
  ...
  "builtin-plugin.code-intelligence.name": "代码智能",
  "builtin-plugin.code-intelligence.desc":
  ...
  "builtin-plugin.android-dev.desc": "Google 官方 Android 开发技能（20 个）+ Android CLI。",
  "builtin-plugin.harmonyos-dev.name": "HarmonyOS 开发",
  "builtin-plugin.harmonyos-dev.desc": "鸿蒙开发技能 + DevEco CLI MCP。",
  "builtin-plugin.expo-dev.name": "Expo 开发",
  "builtin-plugin.expo-dev.desc": "Expo/RN 开发技能 + Expo MCP。源自 expo/skills。",
  "builtin-plugin.dotnet-dev.name": ".NET 开发",
  "builtin-plugin.dotnet-dev.desc": "Microsoft 官方 .NET 技能（96 个）。跨平台。源自 dotnet/skills。",
  "builtin-plugin.qt-dev.name": "Qt/KDE 开发",
  "builtin-plugin.qt-dev.desc": "Qt Group 官方技能（12 个）。跨平台。源自 TheQtCompanyRnD/agent-skills。",
  "builtin-plugin.apple-dev.name": "Apple 平台开发",
  "builtin-plugin.apple-dev.desc": "Apple Xcode 27 第一方技能 + 社区精选。仅 macOS（需 Xcode 27 + xcrun）。",
  "builtin-plugin.deepin-dev.name": "deepin/UOS 开发",
  "builtin-plugin.deepin-dev.desc": "统信官方 deepin 桌面开发技能。仅 Linux。源自 linuxdeepin/deepin-skills。",
  "builtin-plugin.design.name": "设计生成",
  "builtin-plugin.design.desc": "DeepDesign + PM-Designer + taste 设计纪律。",
  "builtin-plugin.documentation.name": "知识与文档",
  "builtin-plugin.documentation.desc": "GitMCP + OpenWiki + 行为记忆（activity-frames）。",
  "builtin-plugin.browser.name": "浏览器与联网",
  "builtin-plugin.browser.desc": "真实 Chrome 操控 + WebSearch + 智能联网策略。",
  "builtin-plugin.security.name": "安全扫描",
  "builtin-plugin.security.desc": "SkillSpector — AI skill/MCP 安全扫描器（68 漏洞模式）。",
  "builtin-plugin.skill-tools.name": "技能工具",
  "builtin-plugin.skill-tools.desc": "编写、消化和管理 Agent 技能。",
  "builtin-plugin.deeporca.name": "DeepOrca",
  "builtin-plugin.deeporca.desc": "产品原生技能与模板——自引用文档和 Bento 幻灯片生成。",
  "builtin-plugin.other.name": "其他",
  "builtin-plugin.other.desc": "未归属任何插件分组的内置项。",
