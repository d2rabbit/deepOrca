...
export const en = {
  ...
  // ── Orca Deck (experimental layout) ───────────────────────
  "settings.appearance.layout": "Layout",
  "layout.classic": "Classic",
  "layout.deck.badge": "Experimental",
  "layout.switch.hint": "Switching layouts reloads the window. Sessions and settings are unaffected.",
  "deck.backToClassic": "Back to Classic",
  "deck.goal.empty": "No active goal",
  "deck.stage.badge": "Experimental · Orca Deck",
  "deck.stage.empty":
    "No active goal. Stamp a new one (⌘N) or pick a session from the workshop wall — steps, approvals and interventions all land here.",
  "deck.dock.notifications": "Notifications",
  "deck.dock.tape": "Tape",
  "deck.dock.theme": "Themes",
  "deck.dock.settings": "Settings",
  "deck.dock.files": "Files",
  "deck.dock.changes": "Changes",
  "deck.dock.processes": "Processes",
  "deck.dock.assets": "Assets",
  "deck.dock.review": "Review",
  "deck.dock.sources": "Sources",
  "deck.dock.ledger": "Ledger",
  "deck.dock.tree": "Task Tree",
  "deck.dock.plugins": "Plugins",
  "deck.dock.checkpoints": "Checkpoints",
  "deck.dock.editor": "Editor",
  "deck.dock.shortcuts": "Shortcuts",
  "deck.dock.floor": "Workshop",
  "deck.dock.newGoal": "New Goal",

  // ── Orca Deck E1/E2 (core loop + functional panels) ──────
  "deck.cc.title": "Control Center",
  "deck.cc.duration": "Duration",
  "deck.cc.cost": "Cost",
  "deck.cc.context": "Context",
  "deck.cc.tokens": "Tokens",
  "deck.cc.commands": "My Commands",
  "deck.cc.commandsEmpty": "No commands sent from Deck yet.",
  "deck.cc.events": "Status Stream",
  "deck.cc.eventsEmpty": "No engine events yet.",
  "deck.steps.title": "Steps",
  "deck.pending.title": "Pending Approval",
  "deck.pending.allow": "Allow",
  "deck.pending.deny": "Deny",
  "deck.pending.always": "Always allow",
  "deck.pending.submit": "Submit",
  "deck.composer.placeholder": "Send a command… (⏎ to send)",
  "deck.tape.empty": "No messages yet.",
  "deck.loading": "Loading…",
  "deck.noSession": "No active goal. Pick a session from the workshop wall first.",
  "deck.floor.empty": "No sessions in this workspace.",
  "deck.checkpoints.empty": "No checkpoints in this session.",
  "deck.checkpoints.restoreCode": "Restore code",
  "deck.checkpoints.restoreChat": "Restore chat",
  "deck.ledger.total": "Total tokens",
  "deck.ledger.cacheHit": "Cache hit",
  "deck.ledger.sessions": "Sessions",
  "deck.tree.empty": "No task trees yet.",
  "deck.tree.nodes": "{count} nodes",
  "deck.files.empty": "Empty workspace.",
  "deck.changes.noRepo": "Not a git repository.",
  "deck.changes.staged": "Staged",
  "deck.changes.unstaged": "Changes",
  "deck.changes.stage": "Stage",
  "deck.changes.unstage": "Unstage",
  "deck.changes.discard": "Discard",
  "deck.changes.discardConfirm": "Discard again to drop",
  "deck.changes.clean": "Working tree clean.",
  "deck.changes.commitPlaceholder": "Commit message…",
  "deck.changes.commit": "Commit",
  "deck.processes.empty": "No background processes in this session.",
  "deck.processes.noOutput": "(no output yet)",
  "deck.plugins.empty": "No MCP servers configured.",
  "deck.plugins.enable": "Enable",
  "deck.plugins.disable": "Disable",
  "deck.review.unavailable": "Code review CLI is not available.",
  "deck.review.run": "Run Review",
  "deck.review.running": "Reviewing…",
  "deck.assets.empty": "No design artifacts yet.",
  // ── Deck E3: command layer / notifications / themes / settings / editor / shortcuts ──
  "deck.cmd.title": "Command Layer",
  "deck.cmd.placeholder": "Type to search — prefix › locks to modules",
  "deck.cmd.empty": "No matching commands.",
  "deck.cmd.interrupt": "Interrupt the running goal",
  "deck.notif.empty": "Nothing yet — engine events land here.",
  "deck.notif.clear": "Clear",
  "deck.theme.name.liquid": "Liquid Glass",
  "deck.theme.name.flat": "Flat",
  "deck.theme.name.glass": "Glassmorphism",
  "deck.theme.name.neu": "Neumorphism",
  "deck.theme.name.clay": "Claymorphism",
  "deck.theme.name.vern": "Vernacular 1997",
  "deck.settings.theme": "Theme",
  "deck.settings.language": "Language",
  "deck.settings.layout": "Layout",
  "deck.settings.layoutDeck": "Orca Deck (experimental)",
  "deck.settings.layoutHint": "Switching reloads the window; sessions are preserved.",
  "deck.editor.pick": "Pick a file from the tree to edit…",
  "deck.editor.save": "Save",
  "deck.editor.saved": "Saved",
  "deck.editor.dirty": "Unsaved",
  "deck.editor.binary": "Binary file — editing skipped.",
  "deck.editor.loadError": "Could not read this file.",
  "deck.shortcuts.global": "Global",
  ...
  "deck.autonomy.label": "Autonomy",
  "deck.autonomy.full": "Full auto",
  "deck.autonomy.key": "Key confirmations",
  "deck.autonomy.each": "Every step",
  "deck.autonomy.hint": "How the Deck answers permission asks (only high-risk still interrupts on full auto)",
  "deck.gate.auto": "Auto",
  "deck.gate.confirmBefore": "Confirm before start",
  "deck.gate.confirmDone": "Confirm when done",
  "deck.gate.card.done": "Step “{step}” finished — continue?",
  "deck.gate.card.before": "Step “{step}” is about to start — confirm?",
  "deck.gate.resume": "Continue",
  "deck.gate.stay": "Stay frozen",
  "deck.draft.namePlaceholder": "Give it a goal…",
  "deck.draft.stepPlaceholder": "Step…",
  "deck.draft.addStep": "Add step",
  "deck.draft.stamp": "Stamp & dispatch",
  "deck.steps.gate": "Gate",
  "deck.steps.strike": "Strike",

  // ── Deck E8: stage tabs + full-body module views ─────────
  "deck.tab.workOrder": "Work Order",
  "deck.tab.open": "Open in tab",
  "deck.tab.close": "Close tab",
  "deck.opFailed": "Operation failed: {error}",
  "deck.tree.pick": "Pick a task tree on the left.",
  "deck.tree.branches": "{count} branches",
  "deck.tree.archived": "Archived",
  "deck.tree.archive": "Archive",
  "deck.tree.unarchive": "Unarchive",
  "deck.tree.active": "current",
  "deck.tree.abandoned": "abandoned",
  "deck.tree.switch": "Switch",
  "deck.tree.merge": "Merge",
  "deck.tree.abandon": "Abandon",
  "deck.tree.abandonConfirm": "Abandon again to confirm",
  "deck.tree.fork": "Fork branch",
  "deck.tree.forkWhy": "Why this fork (required)…",
  "deck.tree.reflog": "Reflog",
  "deck.tree.selectNode": "Click a node for details",
  "deck.tree.artifacts": "{count} artifacts",
  "deck.tree.snapshot": "Restore snapshot ({count} files)",
  "deck.tree.emptyBranch": "(no unique nodes)",
  "deck.sources.workspaces": "Workspaces",
  "deck.sources.symbolHint": "Search symbols…",
  "deck.sources.noResults": "No matches",
  "deck.sources.roleFocus": "Focus",
  "deck.sources.roleCallers": "Callers",
  "deck.sources.roleCallees": "Callees",
  "deck.sources.graphTruncated": "Result list truncated",
  "deck.sources.files": "Files",
  "deck.sources.pages": "Wiki pages",
  "deck.sources.ready": "{ready}/{total} ready",
  "deck.sources.hint": "Recall quality drives agent performance · all local · click a card for details",
  "deck.sources.rebuildAll": "Rebuild all",
  "deck.sources.rebuilding": "Rebuilding…",
  "deck.sources.graphReady": "graph built",
  "deck.sources.noGraph": "no graph",
  "deck.review.runFull": "Run review.full",
  "deck.review.graphReady": "risk graph built",
  "deck.review.graphUnbuilt": "risk graph not built",
  "deck.review.history": "Runs this session",
  "deck.review.findings": "{count} findings",
  "deck.review.noRuns": "No runs yet — kick off a review.",
  "deck.review.failed": "Run failed: {error}",
  "deck.review.risk": "Risk graph: {count} changed nodes",
  "deck.review.noFindings": "No findings — all clear.",
  "deck.review.advisory": "Advice",
  "deck.review.finding": "Finding",
  ...
  // ── Deck E10: interaction-layer completion (decision blocks, zen, directive input) ──
  "deck.question.title": "Agent asks",
  "deck.question.multi": "multi-select",
  "deck.question.textPlaceholder": "Type your answer…",
  "deck.question.decline": "Skip — let it decide",
  "deck.cc.directive": "Issue directive",
  "deck.cc.directivePlaceholder": "Intervene on the selected target…",
  "deck.cc.targetGoal": "Goal",
  "deck.goal.steps": "{done}/{total} steps",
  "deck.goal.frozen": "⏸ Frozen",
  "deck.goal.status.live": "In progress",
  "deck.goal.status.done": "Delivered",
  "deck.goal.status.idle": "Pending",
  "deck.goal.status.attention": "Needs your input",
  "deck.floor.status.live": "In progress",
  "deck.floor.status.done": "Delivered",
  "deck.floor.status.failed": "Failed",
  "deck.floor.status.attention": "Needs attention",
  "deck.floor.archive": "Archive",
  "deck.floor.rename": "Rename",
  "deck.floor.delete": "Delete",
  "deck.floor.deleteConfirm": "Click again to delete",
  "deck.floor.export": "Export",
  "deck.floor.exported": "Exported to {path}",
  "deck.compacted": "Context compacted · freed {freed}",
  "deck.cc.planHint": "Plan mode for the next send — the agent proposes a plan first",
  "deck.cc.enhanceHint": "Enhance the prompt with the model before sending",
  "deck.cc.modelHint": "Active model — switches apply to subsequent requests",
  "deck.cc.thinkHint": "Thinking tier — follows what the current model family serves",
  "deck.onboard.autonomy": "Default autonomy",
  "deck.onboard.auto0": "Only high-risk interrupts you",
  "deck.onboard.auto1": "Ask before writes · recommended",
  "deck.onboard.auto2": "Stamp every step before it starts",
  "deck.onboard.recommended": "Recommended",
  "deck.cmd.zen": "Toggle focus mode",
  "deck.steps.struck": "Struck",
  "deck.steps.unstrike": "Unstrike",
  "deck.steps.expand": "Expand",
  "deck.steps.strikeHint": "Double-click to strike this step",
  "deck.steps.struckHint": "Double-click to restore this step",
  "deck.steps.gateHint": "Click to cycle the gate — overrides the autonomy default",
  "deck.autonomy.scope": "· steps without a gate follow this level",
  "deck.shortcuts.cc": "Control center",
  "deck.shortcuts.zen": "Focus mode",
  "deck.shortcuts.brake": "Brake / resume",
  "deck.shortcuts.stepNav": "Step navigation",
  "deck.shortcuts.autonomy": "Autonomy levels",
  "deck.shortcuts.send": "Send command",
  // ── Deck E11: context focus card + ledger meters + plugin/asset detail ──
  "deck.context.title": "Context breakdown",
  "deck.context.active": "Active context",
  "deck.context.threshold": "Compaction threshold",
  "deck.context.prompt": "Prompt tokens (total)",
  "deck.context.completion": "Completion tokens (total)",
  "deck.context.watermark": "Context watermark · {pct}%",
  "deck.context.watermarkHint": "Compaction triggers near {threshold} (model: {model})",
  "deck.context.cache": "Prompt cache hit rate · {pct}%",
  "deck.context.cacheHint": "hit {hit} · miss {miss}",
  "deck.ledger.byModel": "By model",
  "deck.ledger.bySession": "By work order",
  "deck.ledger.reqs": "{count} requests",
  "deck.plugins.tools": "Tools · {count}",
  "deck.plugins.noTools": "No tools reported yet — the server may still be starting.",
  "deck.plugins.disabledState": "Disabled",
  "deck.assets.updated": "Updated",
} as const;
...
export const zh: Record<MessageKey, string> = {
  ...
  "shortcuts.toggleSidebar": "切换枢纽",
  "sheet.backToChat": "返回对话",
  ...
  // ── Orca Deck（实验布局）─────────────────────────────────
  "settings.appearance.layout": "界面布局",
  "layout.classic": "经典",
  "layout.deck.badge": "实验",
  "layout.switch.hint": "切换布局将重载窗口，会话与设置不受影响。",
  "deck.backToClassic": "切回经典",
  "deck.goal.empty": "暂无进行中的目标",
  "deck.stage.badge": "实验 · Orca Deck",
  "deck.stage.empty":
    "暂无进行中的目标。盖章下发一个新目标（⌘N），或去车间墙挑一个会话——步骤、审批与介入都在这里完成。",
  "deck.dock.notifications": "通知",
  "deck.dock.tape": "记录",
  "deck.dock.theme": "主题",
  "deck.dock.settings": "设置",
  "deck.dock.files": "文件",
  "deck.dock.changes": "变更",
  "deck.dock.processes": "进程",
  "deck.dock.assets": "资产",
  "deck.dock.review": "审查",
  "deck.dock.sources": "知识源",
  "deck.dock.ledger": "账本",
  "deck.dock.tree": "任务树",
  "deck.dock.plugins": "插件",
  "deck.dock.checkpoints": "检查点",
  "deck.dock.editor": "编辑器",
  "deck.dock.shortcuts": "快捷键",
  "deck.dock.floor": "车间墙",
  "deck.dock.newGoal": "新目标",

  // ── Orca Deck E1/E2（核心闭环 + 功能面板）─────────────────
  "deck.cc.title": "控制中心",
  "deck.cc.duration": "时长",
  "deck.cc.cost": "成本",
  "deck.cc.context": "上下文",
  "deck.cc.tokens": "Token",
  "deck.cc.commands": "我的指令",
  "deck.cc.commandsEmpty": "还没有从 Deck 发出过指令。",
  "deck.cc.events": "状态观测流",
  "deck.cc.eventsEmpty": "暂无引擎事件。",
  "deck.steps.title": "步骤",
  "deck.pending.title": "待批准",
  "deck.pending.allow": "允许",
  "deck.pending.deny": "拒绝",
  "deck.pending.always": "始终允许",
  "deck.pending.submit": "提交",
  "deck.composer.placeholder": "发送指令…（⏎ 发送）",
  "deck.tape.empty": "暂无消息。",
  "deck.loading": "加载中…",
  "deck.noSession": "暂无进行中的目标，请先从车间墙选择会话。",
  "deck.floor.empty": "该工作区暂无会话。",
  "deck.checkpoints.empty": "当前会话暂无检查点。",
  "deck.checkpoints.restoreCode": "恢复代码",
  "deck.checkpoints.restoreChat": "恢复对话",
  "deck.ledger.total": "Token 总量",
  "deck.ledger.cacheHit": "缓存命中",
  "deck.ledger.sessions": "会话数",
  "deck.tree.empty": "暂无任务树。",
  "deck.tree.nodes": "{count} 个节点",
  "deck.files.empty": "工作区为空。",
  "deck.changes.noRepo": "当前目录不是 git 仓库。",
  "deck.changes.staged": "暂存区",
  "deck.changes.unstaged": "更改",
  "deck.changes.stage": "暂存",
  "deck.changes.unstage": "移出",
  "deck.changes.discard": "还原",
  "deck.changes.discardConfirm": "再点一次确认丢弃",
  "deck.changes.clean": "工作区干净，无变更。",
  "deck.changes.commitPlaceholder": "提交信息…",
  "deck.changes.commit": "提交",
  "deck.processes.empty": "当前会话暂无后台进程。",
  "deck.processes.noOutput": "（暂无输出）",
  "deck.plugins.empty": "未配置 MCP 服务器。",
  "deck.plugins.enable": "启用",
  "deck.plugins.disable": "停用",
  "deck.review.unavailable": "代码审查 CLI 不可用。",
  "deck.review.run": "运行审查",
  "deck.review.running": "审查中…",
  "deck.assets.empty": "暂无设计资产。",
  // ── Deck E3：命令层 / 通知 / 主题 / 设置 / 编辑器 / 快捷键 ──
  "deck.cmd.title": "命令层",
  "deck.cmd.placeholder": "输入以搜索命令 — 前缀 › 仅锁定模块",
  "deck.cmd.empty": "没有匹配的命令。",
  "deck.cmd.interrupt": "中断进行中的目标",
  "deck.notif.empty": "还没有通知 — 引擎事件会落在这里。",
  "deck.notif.clear": "清空",
  "deck.theme.name.liquid": "Liquid Glass",
  "deck.theme.name.flat": "扁平",
  "deck.theme.name.glass": "玻璃拟态",
  "deck.theme.name.neu": "新拟态",
  "deck.theme.name.clay": "黏土拟态",
  "deck.theme.name.vern": "乡土 1997",
  "deck.settings.theme": "主题",
  "deck.settings.language": "语言",
  "deck.settings.layout": "界面布局",
  "deck.settings.layoutDeck": "Orca Deck（实验）",
  "deck.settings.layoutHint": "切换会重载窗口；会话数据不丢失。",
  "deck.editor.pick": "从左侧文件树选择要编辑的文件…",
  "deck.editor.save": "保存",
  "deck.editor.saved": "已保存",
  "deck.editor.dirty": "未保存",
  "deck.editor.binary": "二进制文件 — 跳过编辑。",
  "deck.editor.loadError": "无法读取该文件。",
  "deck.shortcuts.global": "全局",
  ...
  "deck.autonomy.full": "全自动",
  "deck.autonomy.key": "关键确认",
  "deck.autonomy.each": "每步确认",
  "deck.autonomy.hint": "Deck 如何应答权限询问（全自动下仅高危仍会拦截）",
  "deck.gate.auto": "自动",
  "deck.gate.confirmBefore": "开工前确认",
  "deck.gate.confirmDone": "完成时确认",
  "deck.gate.card.done": "步骤「{step}」完成 — 继续吗？",
  "deck.gate.card.before": "步骤「{step}」即将开工 — 确认？",
  "deck.gate.resume": "继续",
  "deck.gate.stay": "保持冻结",
  "deck.draft.namePlaceholder": "给它一个目标…",
  "deck.draft.stepPlaceholder": "步骤…",
  "deck.draft.addStep": "添加步骤",
  "deck.draft.stamp": "盖章下发",
  "deck.steps.gate": "闸门",
  "deck.steps.strike": "划线",

  // ── Deck E8: stage tabs + full-body module views ─────────
  "deck.tab.workOrder": "工单",
  "deck.tab.open": "在标签页打开",
  "deck.tab.close": "关闭标签页",
  "deck.opFailed": "操作失败：{error}",
  "deck.tree.pick": "在左侧选择一棵任务树。",
  "deck.tree.branches": "{count} 个分支",
  "deck.tree.archived": "已归档",
  "deck.tree.archive": "归档",
  "deck.tree.unarchive": "取消归档",
  "deck.tree.active": "当前",
  "deck.tree.abandoned": "已放弃",
  "deck.tree.switch": "切换",
  "deck.tree.merge": "合并",
  "deck.tree.abandon": "放弃",
  "deck.tree.abandonConfirm": "再点一次确认放弃",
  "deck.tree.fork": "分叉分支",
  "deck.tree.forkWhy": "分叉缘由（必填）…",
  "deck.tree.reflog": "操作日志",
  "deck.tree.selectNode": "点击节点查看详情",
  "deck.tree.artifacts": "{count} 个工件",
  "deck.tree.snapshot": "恢复快照（{count} 个文件）",
  "deck.tree.emptyBranch": "（无独有节点）",
  "deck.sources.workspaces": "工作区",
  "deck.sources.symbolHint": "检索符号…",
  "deck.sources.noResults": "无匹配结果",
  "deck.sources.roleFocus": "焦点",
  "deck.sources.roleCallers": "调用方",
  "deck.sources.roleCallees": "被调用",
  "deck.sources.graphTruncated": "结果已截断",
  "deck.sources.files": "文件",
  "deck.sources.pages": "知识页",
  "deck.sources.ready": "{ready}/{total} 就绪",
  "deck.sources.hint": "召回质量直接影响 agent 表现 · 全部本地 · 点击卡片进详情",
  "deck.sources.rebuildAll": "全部重建",
  "deck.sources.rebuilding": "重建中…",
  "deck.sources.graphReady": "图已构建",
  "deck.sources.noGraph": "图未构建",
  "deck.review.runFull": "运行 review.full",
  "deck.review.graphReady": "风险图已构建",
  "deck.review.graphUnbuilt": "风险图未构建",
  "deck.review.history": "本次会话运行记录",
  "deck.review.findings": "{count} 条发现",
  "deck.review.noRuns": "还没有运行记录 — 发起一次审查。",
  "deck.review.failed": "运行失败：{error}",
  "deck.review.risk": "风险图：{count} 个变更节点",
  "deck.review.noFindings": "无发现 — 全部通过。",
  "deck.review.advisory": "建议",
  "deck.review.finding": "发现",
  ...
  // ── Deck E10：交互层补全（决策块 / 专注模式 / 指令输入） ──
  "deck.question.title": "agent 提问",
  "deck.question.multi": "可多选",
  "deck.question.textPlaceholder": "输入你的回答…",
  "deck.question.decline": "跳过，让它自己定",
  "deck.cc.directive": "下达指令",
  "deck.cc.directivePlaceholder": "对选中对象介入…",
  "deck.cc.targetGoal": "目标",
  "deck.goal.steps": "{done}/{total} 步",
  "deck.goal.frozen": "⏸ 已冻结",
  "deck.goal.status.live": "施工中",
  "deck.goal.status.done": "已交付",
  "deck.goal.status.idle": "待施工",
  "deck.goal.status.attention": "待你定夺",
  "deck.floor.status.live": "施工中",
  "deck.floor.status.done": "已交付",
  "deck.floor.status.failed": "已失败",
  "deck.floor.status.attention": "待确认",
  "deck.floor.archive": "归档",
  "deck.floor.rename": "重命名",
  "deck.floor.delete": "删除",
  "deck.floor.deleteConfirm": "再点一次确认删除",
  "deck.floor.export": "导出",
  "deck.floor.exported": "已导出到 {path}",
  "deck.compacted": "上下文已压缩 · 释放 {freed}",
  "deck.cc.planHint": "下次发送进入 Plan 模式——agent 先出方案再施工",
  "deck.cc.enhanceHint": "发送前用模型增强提示词",
  "deck.cc.modelHint": "当前模型——切换对后续请求生效",
  "deck.cc.thinkHint": "思考档位——跟随当前模型家族实际支持的档位",
  "deck.onboard.autonomy": "默认自律度",
  "deck.onboard.auto0": "只有高危才拦你",
  "deck.onboard.auto1": "写文件前问我 · 推荐",
  "deck.onboard.auto2": "每步开工前盖章",
  "deck.onboard.recommended": "推荐",
  "deck.cmd.zen": "切换专注模式",
  "deck.steps.struck": "已划线",
  "deck.steps.unstrike": "恢复步骤",
  "deck.steps.expand": "展开",
  "deck.steps.strikeHint": "双击划线删除此步骤",
  "deck.steps.struckHint": "双击恢复此步骤",
  "deck.steps.gateHint": "点击切换闸门 · 覆盖自律度默认值",
  "deck.autonomy.scope": "· 未单独设闸门的步骤按此档执行",
  "deck.shortcuts.cc": "控制中心",
  "deck.shortcuts.zen": "专注模式",
  "deck.shortcuts.brake": "刹车 / 恢复",
  "deck.shortcuts.stepNav": "步骤间跳转",
  "deck.shortcuts.autonomy": "自律度三档",
  "deck.shortcuts.send": "发送指令",
  // ── Deck E11：上下文焦点卡 + 账本 meter + 插件/资产详情 ──
  "deck.context.title": "上下文拆解",
  "deck.context.active": "当前上下文",
  "deck.context.threshold": "压缩阈值",
  "deck.context.prompt": "Prompt tokens（累计）",
  "deck.context.completion": "Completion tokens（累计）",
  "deck.context.watermark": "上下文水位 · {pct}%",
  "deck.context.watermarkHint": "接近 {threshold} 时触发压缩（模型：{model}）",
  "deck.context.cache": "Prompt 缓存命中率 · {pct}%",
  "deck.context.cacheHint": "命中 {hit} · 未命中 {miss}",
  "deck.ledger.byModel": "按模型",
  "deck.ledger.bySession": "按工单",
  "deck.ledger.reqs": "{count} 次请求",
  "deck.plugins.tools": "工具 · {count}",
  "deck.plugins.noTools": "尚无工具上报——服务器可能仍在启动。",
  "deck.plugins.disabledState": "已停用",
  "deck.assets.updated": "更新于",
};
