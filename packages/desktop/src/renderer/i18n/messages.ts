...
export const en = {
  ...
  "deck.stage.badge": "Experimental · E0 skeleton",
  "deck.stage.empty":
    "The Orca Deck shell is ready. Tape, the step board and the control center arrive in the next phase.",
...
export const zh: Record<MessageKey, string> = {
  ...
  "deck.stage.badge": "实验 · E0 骨架",
  "deck.stage.empty": "Orca Deck 骨架已就绪，Tape、步骤板与控制中心将在下一阶段接入。",
