...
export const en = {
  ...
  "builtin-plugin.react-native-dev.name": "React Native Development",
  "builtin-plugin.react-native-dev.desc": "RN dev skills (Expo + Callstack) + Expo MCP.",
  "builtin-plugin.apple-dev.name": "Apple Platform Development",
  "builtin-plugin.apple-dev.desc": "Apple Xcode 27 first-party skills + community. macOS only.",
  "builtin-plugin.dotnet-dev.name": ".NET Development",
  "builtin-plugin.dotnet-dev.desc": "Microsoft official .NET skills (12 domains). Cross-platform.",
  "builtin-plugin.qt-dev.name": "Qt/KDE Development",
  "builtin-plugin.qt-dev.desc": "Qt Group official skills (7) + Qt docs MCP. Cross-platform.",
  "builtin-plugin.deepin-dev.name": "deepin/UOS Development",
  "builtin-plugin.deepin-dev.desc": "Official deepin desktop dev skills (4). Linux only.",
...
export const zh: Record<MessageKey, string> = {
  ...
  "builtin-plugin.react-native-dev.name": "React Native 开发",
  "builtin-plugin.react-native-dev.desc": "RN 开发技能（Expo + Callstack）+ Expo MCP。",
  "builtin-plugin.apple-dev.name": "Apple 平台开发",
  "builtin-plugin.apple-dev.desc": "Apple Xcode 27 第一方技能 + 社区精选。仅 macOS。",
  ...
  "builtin-plugin.qt-dev.desc": "Qt Group 官方技能（7 个）+ Qt 文档 MCP。跨平台。",
  "builtin-plugin.deepin-dev.name": "deepin/UOS 开发",
  "builtin-plugin.deepin-dev.desc": "统信官方 deepin 桌面开发技能（4 个）。仅 Linux。",
