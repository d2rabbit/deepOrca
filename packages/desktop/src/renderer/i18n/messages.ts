...
export const en = {
  ...
  "deck.placeholder.theme": "Deck themes land with the E2 theme work — only Liquid Glass for now.",
  "deck.placeholder.notifications": "Notifications arrive with the overlay stack (E3).",
  "deck.placeholder.e3": "This module lands in E3. Use the classic layout for now.",
} as const;
...
export const zh: Record<MessageKey, string> = {
  ...
  "deck.placeholder.theme": "Deck 主题将随 E2 主题工作落地，当前仅 Liquid Glass。",
  "deck.placeholder.notifications": "通知将随浮层栈（E3）落地。",
  "deck.placeholder.e3": "该模块将在 E3 落地，请暂时使用经典布局。",
};
