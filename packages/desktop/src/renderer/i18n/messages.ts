...
export const en = {
  ...
  "settings.memory.port": "Gateway port",
  "settings.memory.checking": "Checking availability…",
  "settings.memory.unavailable": "Memory gateway not available",
  "settings.memory.available": "Memory gateway available",
...
export const zh: Record<MessageKey, string> = {
  ...
  "settings.memory.port": "网关端口",
  "settings.memory.checking": "检查可用性…",
  "settings.memory.unavailable": "记忆网关不可用",
  "settings.memory.available": "记忆网关可用",
