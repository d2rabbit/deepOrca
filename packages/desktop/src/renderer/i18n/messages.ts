...
export const en = {
  ...
  "builtin-plugin.android-dev.desc": "Official Android skills (14) + Android CLI integration",
  "builtin-plugin.harmonyos-dev.name": "HarmonyOS Development",
  "builtin-plugin.harmonyos-dev.desc": "HarmonyOS skills + DevEco CLI MCP",
  "builtin-plugin.react-native-dev.name": "React Native Development",
  "builtin-plugin.react-native-dev.desc": "RN skills (Expo + Callstack) + Expo MCP",
  "builtin-plugin.browser.name": "Browser & Web Access",
  "builtin-plugin.browser.desc": "Chrome control + web search + access strategy",
...
export const zh: Record<MessageKey, string> = {
  ...
  "builtin-plugin.flutter-dev.name": "Flutter 开发插件",
  "builtin-plugin.flutter-dev.desc": "Flutter/Dart 开发专家技能包，涵盖架构、测试、路由、本地化、HTTP、FFI 等。",
  "builtin-plugin.codegraph.name": "CodeGraph",
  "builtin-plugin.codegraph.desc": "预索引的代码知识图谱——符号导航、调用关系与依赖图，实现即时检索。",
  "builtin-plugin.code-review.name": "代码审查",
  "builtin-plugin.code-review.desc": "AI 代码审查（Open Code Review）+ 风险评分与影响范围分析（code-review-graph）。",
  "builtin-plugin.gitmcp.name": "GitMCP",
  "builtin-plugin.gitmcp.desc": "将任意 GitHub 仓库转为 Agent 可查询的 MCP 知识源。",
  "builtin-plugin.openwiki.name": "OpenWiki",
  "builtin-plugin.openwiki.desc": "自动生成并维护项目 Wiki，供 Agent 引用。",
  "builtin-plugin.browser-skill.name": "浏览器技能",
  "builtin-plugin.browser-skill.desc": "驱动用户的真实 Chromium 浏览器——访问页面、填写表单、抓取数据、回归测试 UI。",
  ...
  "builtin-plugin.android-dev.desc": "官方 Android 技能（14 个）+ Android CLI 集成",
  ...
  "builtin-plugin.browser.desc": "Chrome 操控 + 网络搜索 + 联网策略",
