...
export const en = {
  ...
  "index.memory.usage": "LLM usage (calls · tokens)",
  ...
  "index.codegraphTab": "符号索引",
  "index.wikiTab": "Wiki",
  "index.agentsTab": "AGENTS",
  "index.archmapsTab": "Architecture",
  "index.symbolsTab": "Symbols",
  "index.symbolSearch": "Search symbols…",
  ...
  "index.codegraphAutoSync": "Symbol index auto-sync active (file watcher + post-turn)",
  ...
  "index.wikiManualSync": "Wiki manual sync — click Update after significant changes",
  "index.update": "Update",
  "index.updating": "Updating…",
  "index.initializing": "Generating…",
  "index.buildIndex": "Build Symbol Index",
  "index.build": "Build",
...
export const zh: Record<MessageKey, string> = {
  ...
  "index.memory.usage": "LLM 消耗（次数 · tokens）",
  ...
  "index.codegraphAutoSync": "符号索引自动同步已激活（文件监听 + 轮次后同步）",
  "index.wikiReady": "Wiki 已生成",
  "index.wikiEmpty": "Wiki 未生成",
  "index.wikiUnavailable": "Wiki 在当前构建中不可用。",
