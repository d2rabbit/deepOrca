...
export const ko: Record<MessageKey, string> = {
  ...
  "prototypeWorkspace.specViewPd": "프롬프트",
  "prototypeWorkspace.pdRegen": "pd-design 재생성",
  "prototypeWorkspace.pdRegenHint": "현재 PRD로부터 pd-design.md를 재증류(파생 프로토타입 초기화)",
  "prototypeWorkspace.pdRegenDone": "pd-design.md 재생성됨",
  "prototypeWorkspace.progressPdDesign": "pd-design 프롬프트 문서 증류 중…",
  "prototypeWorkspace.progressPdDesignSaved": "pd-design.md 저장됨",
  "prototypeWorkspace.progressPdDesignDegraded": "pd-design 증류 실패——요구문서 기반 직접 생성으로 대체했습니다",
