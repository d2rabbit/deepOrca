...
export const ko: Record<MessageKey, string> = {
  ...
  "editor.agent.title": "디지털 엔티티에게 질문",
  "editor.agent.ask": "선택 영역 질문",
  "editor.agent.placeholder": "이 선택 영역으로 무엇을 할까요? (⌘⏎ 전송)",
  "editor.agent.hint": "대화에서 실행 — 응답은 대화에 스트리밍됩니다.",
  "editor.agent.send": "전송",
  "editor.agent.sent": "✓ 대화에 전송됨",
  "editor.agent.running": "디지털 엔티티 실행 중…",
  "editor.agent.apply": "선택 영역에 적용",
  "editor.agent.toChat": "대화로",
