...
export const ko: Record<MessageKey, string> = {
  ...
  "review.drift.title": "브랜드 드리프트 게이트",
  "review.drift.hint": "브랜드 기준선 대비 결정론적 0–100 드리프트 점수(dembrandt --compare, LLM 미사용).",
  "review.drift.baseline": "기준선 JSON 경로 또는 URL",
  "review.drift.current": "현재 사이트 URL 또는 로컬 파일",
  "review.drift.run": "드리프트 검사 실행",
  "review.drift.detected": "드리프트 감지됨",
  "review.drift.pass": "기준선 내",
  "review.drift.score": "점수 {score}",
  "review.drift.details": "토큰별 상세",
