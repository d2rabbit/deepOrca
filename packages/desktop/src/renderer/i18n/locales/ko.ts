...
export const ko: Record<MessageKey, string> = {
  ...
  "builtin-plugin.android-dev.desc": "공식 Android 스킬(20개) + Android CLI.",
  "builtin-plugin.harmonyos-dev.name": "HarmonyOS 개발",
  "builtin-plugin.harmonyos-dev.desc": "HarmonyOS 스킬 + DevEco CLI MCP.",
  "builtin-plugin.expo-dev.name": "Expo 개발",
  "builtin-plugin.expo-dev.desc": "Expo/RN 스킬 + Expo MCP. expo/skills 출처.",
  "builtin-plugin.dotnet-dev.name": ".NET 개발",
  "builtin-plugin.dotnet-dev.desc": "Microsoft 공식 .NET 스킬(96개). 크로스 플랫폼.",
  "builtin-plugin.qt-dev.name": "Qt/KDE 개발",
  "builtin-plugin.qt-dev.desc": "Qt Group 공식 스킬(12개). 크로스 플랫폼.",
  "builtin-plugin.apple-dev.name": "Apple 플랫폼 개발",
  "builtin-plugin.apple-dev.desc": "Apple Xcode 27 공식 스킬 + 커뮤니티. macOS 전용.",
  "builtin-plugin.deepin-dev.name": "deepin/UOS 개발",
  "builtin-plugin.deepin-dev.desc": "공식 deepin 데스크톱 스킬. Linux 전용.",
  "builtin-plugin.design.name": "디자인 생성",
  "builtin-plugin.design.desc": "DeepDesign + PM-Designer + taste 디자인 원칙.",
  "builtin-plugin.documentation.name": "지식 & 문서",
  "builtin-plugin.documentation.desc": "GitMCP + OpenWiki + 행동 메모리(activity-frames).",
  "builtin-plugin.browser.name": "브라우저 및 웹 액세스",
  "builtin-plugin.browser.desc": "Chrome 제어 + 웹 검색 + 액세스 전략.",
  "builtin-plugin.security.name": "보안 스캔",
  "builtin-plugin.security.desc": "SkillSpector — AI 스킬/MCP 보안 스캐너(68 취약점 패턴).",
  "builtin-plugin.skill-tools.name": "스킬 도구",
  "builtin-plugin.skill-tools.desc": "Agent 스킬 작성, 소화 및 관리.",
  "builtin-plugin.deeporca.name": "DeepOrca",
  "builtin-plugin.deeporca.desc": "제품 네이티브 스킬 및 템플릿 — 자체 참조 문서 및 Bento 슬라이드 생성.",
