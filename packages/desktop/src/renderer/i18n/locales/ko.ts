...
export const ko: Record<MessageKey, string> = {
  ...
  "builtin-plugin.react-native-dev.name": "React Native 개발",
  "builtin-plugin.react-native-dev.desc": "RN 스킬(Expo + Callstack) + Expo MCP.",
  ...
  "builtin-plugin.dotnet-dev.desc": "Microsoft 공식 .NET 스킬(12 도메인). 크로스 플랫폼.",
  "builtin-plugin.qt-dev.name": "Qt/KDE 개발",
  "builtin-plugin.qt-dev.desc": "Qt Group 공식 스킬(7개) + Qt 문서 MCP. 크로스 플랫폼.",
  "builtin-plugin.deepin-dev.name": "deepin/UOS 개발",
  "builtin-plugin.deepin-dev.desc": "공식 deepin 데스크톱 스킬(4개). Linux 전용.",
