...
export const ko: Record<MessageKey, string> = {
  ...
  "common.save": "저장",
  "common.cancel": "취소",
  "designTheme.themeLabel": "요구 테마",
  "prototypeWorkspace.specViewPm": "프롬프트",
  "prototypeWorkspace.pdRegen": "pm-design 재생성",
  "prototypeWorkspace.pdRegenHint": "현재 PRD로부터 pm-design.md를 재증류(파생 프로토타입 초기화)",
  "prototypeWorkspace.pdRegenDone": "pm-design.md 재생성됨",
  "prototypeWorkspace.progressPmDesign": "pm-design 프롬프트 문서 증류 중…",
  "prototypeWorkspace.progressPmDesignSaved": "pm-design.md 저장됨",
  "prototypeWorkspace.progressPmDesignDegraded": "pm-design 증류 실패——요구문서 기반 직접 생성으로 대체했습니다",
  "designWorkspace.progressUiDesign": "ui-design 프롬프트 문서로 강화 중…",
  "designWorkspace.progressUiDesignSaved": "ui-design.md 증류됨",
  "designWorkspace.progressUiDesignDegraded": "ui-design 강화 실패——프로토타입 기반 직접 캔버스 생성으로 대체했습니다",
  "designTheme.contextTitle": "설계 컨텍스트(테마 / 단계 / 관계)",
  "designTheme.themeNone": "테마 없음",
  "designTheme.relationNone": "설정 안 함",
  "designTheme.stageLabel": "단계",
  "designTheme.stagePlaceholder": "예: 1단계",
  "designTheme.inheritsFrom": "상속",
  "designTheme.references": "참조",
  "designTheme.missingTheme": "테마 삭제됨",
  "designTheme.newTheme": "테마 만들기",
  "designTheme.themeTitlePlaceholder": "테마 이름(예: 로그인)",
  "designTheme.renameTheme": "테마 이름 변경",
  "designTheme.deleteThemeHint": "테마 삭제(PRD는 삭제되지 않고 연결만 해제)",
  "designTheme.confirmDelete": "삭제 확인",
  ...
  "msg.refKind.review": "리뷰",
  "msg.refKind.file": "파일",
  "msg.refKind.dir": "폴더",
  "msg.refKind.cmd": "명령",
  "msg.refKind.skill": "스킬",
  "msg.refKind.design": "UI 디자인",
  "msg.refKind.prototype": "프로토타입",
  ...
  "theme.neumorph": "소프트 UI(뉴모피즘)",
  "theme.raw": "있는 그대로(웹 브루탈리즘)",
  "theme.neobrutal": "네오브루탈리즘",
  "theme.minimal": "미니멀",
  "theme.clay": "클레이",
  "theme.geocities": "90년대 홈페이지",
  "theme.y2k": "Y2K(크롬)",
  "theme.skeuo": "스큐어모피즘(실제 질감)",
  "decision.default": "기본",
  "decision.allow": "허용",
  "decision.ask": "확인",
  "decision.deny": "거부",
  ...
  "taskhub.forkMode.worktree": "worktree 샌드박스",
  "taskhub.forkMode.branch": "독립 브랜치 (git 연동)",
  "taskhub.forkMode.worktreeNote": "샌드박스는 .deeporca/task-trees 내부 —— 워크스페이스 저장소 안의 격리.",
  "taskhub.forkMode.branchNote":
    "git 브랜치 + 리포지토리 외부 임시 worktree 체크아웃 —— 파일 변경은 구조적으로 격리되어 상위 워크스페이스에 영향 없음.",
  "taskhub.mergeGo": "머지",
  "taskhub.merged": "머지됨",
  "taskhub.mergeConflicts": "아티팩트 충돌 {n}건 —— 표시만 하고 자동 해제 없음",
  "taskhub.legend.session": "세션 메인 작업",
  "taskhub.legend.fork": "fork 브랜치 (↔ git 브랜치)",
  "taskhub.legend.side": "병행 작업",
  "taskhub.legend.abandoned": "abandoned 페이드",
  "taskhub.legend.merge": "merge 라인",
  "taskhub.all": "전체",
  ...
  "taskhub.status.interrupted": "중단됨",
  "taskhub.detail.command": "명령",
  "taskhub.detail.file": "파일",
  "taskhub.detail.link": "링크",
  "taskhub.detail.query": "검색",
  "taskhub.detail.content": "내용",
  "taskhub.detail.change": "변경",
  "taskhub.detail.questions": "질문",
  "taskhub.detail.plan": "계획",
  "taskhub.detail.reply": "응답",
  "taskhub.detail.interruptedNote": "이 호출은 완료 전에 중단되어 결과가 기록되지 않았습니다.",
  ...
  "app.name": "DeepOrca",
  "settings.tab.entities": "디지털 엔티티",
  "settings.entities.title": "디지털 엔티티",
  "settings.entities.intro":
    "제품에 내장된 디지털 엔티티(자율 동작하는 디지털 작업자) — 각각 실제 백그라운드 파이프라인에 대응합니다. 커스텀 엔티티는 아직 미개방입니다.",
  "settings.entities.builtin": "내장",
  "settings.entities.customSoon": "커스텀 디지털 엔티티는 이후 버전에서 개방됩니다.",
  "settings.entities.arch.name": "아키텍처 분석가",
  "settings.entities.arch.desc": "저장소 구조를 스캔해 아키텍처 맵 생성(arch-scan 파이프라인).",
  "settings.entities.review.name": "코드 리뷰어",
  "settings.entities.review.desc": "증분 / 전체 코드 리뷰와 구조화 리포트 생성.",
  "settings.entities.wiki.name": "지식 빌더",
  "settings.entities.wiki.desc": "코드 지식베이스와 이중언어 Wiki 구축(index build 파이프라인).",
  "settings.entities.risk.name": "리스크 분석가",
  ...
  "editor.preview.unavailable": "이 파일은 미리 볼 수 없습니다.",
  "editor.preview.failed": "미리 보기 로드 실패: {error}",
  "editor.preview.openSystem": "시스템에서 열기",
  ...
  "editor.pair.tabAi": "AI 변경 검토 대기",
  "editor.pair.placeholder": "의도를 한 줄로… (@ 파일 · # 심볼)",
  "editor.pair.send": "보내기",
  "editor.pair.toChat": "대화로",
  "editor.pair.clarify.title": "확인이 필요합니다:",
  "editor.pair.written": "쓰는 중 {written}/{total} 줄",
  "editor.pair.step.read": "선택 이해",
  "editor.pair.step.plan": "설계",
  "editor.pair.step.write": "캔버스에 쓰기",
  "editor.pair.step.verify": "검증",
  "editor.pair.ctx.selection": "선택",
  "editor.pair.ctx.lines": "줄",
  "editor.pair.ctx.add": "컨텍스트",
  "editor.pair.ctx.noFiles": "다른 열린 파일이 없습니다.",
  "editor.pair.intent.explain": "설명",
  "editor.pair.intent.explain.prompt": "이 코드의 책임과 경계 조건을 설명해 줘",
  "editor.pair.intent.refactor": "리팩터",
  "editor.pair.intent.refactor.prompt": "리팩터: 작은 함수로 분리, 동작은 유지",
  "editor.pair.intent.optimize": "최적화해 줘",
  "editor.pair.intent.optimize.prompt": "최적화해 줘",
  "editor.head.pair": "페어",
  "editor.head.commands": "명령",
  "editor.head.lane": "페어 레인",
  "editor.pair.explain.title": "코드 설명",
  "editor.pair.explain.running": "설명 중…",
  "editor.pair.explain.instruction":
    "선택한 코드의 책임, 의도, 경계 조건을 설명하세요. 설명 텍스트만 출력하고 코드 블록이나 코드 재작성은 하지 마세요.",
  "editor.pair.explain.hint": "읽기 전용 설명 — 버퍼는 수정되지 않습니다.",
  "editor.pair.lane.followup": "추가 지시 / 이어서…",
  "editor.ctx.pair": "인라인 페어",
  "editor.ctx.explain": "선택 영역 설명",
  "editor.ctx.refactor": "선택 영역 리팩터",
  "editor.ctx.optimize": "최적화",
  "editor.ctx.toSession": "대화로 보내기",
  "editor.ctx.copy": "복사",
  "editor.ctx.paste": "붙여넣기",
  "editor.ctx.selectAll": "전체 선택",
  "editor.search.find": "찾기",
  "editor.search.replace": "바꾸기",
  "editor.search.next": "다음",
  "editor.search.previous": "이전",
  "editor.search.all": "모두",
  "editor.search.matchCase": "대/소문자 구분",
  "editor.search.regexp": "정규식",
  "editor.search.byWord": "단어 단위",
  "editor.search.replaceBtn": "바꾸기",
  "editor.search.replaceAll": "모두 바꾸기",
  "editor.search.close": "닫기",
  "editor.pair.review.prevHunk": "이전 hunk",
  "editor.pair.review.nextHunk": "다음 hunk",
  "editor.pair.review.preview": "diff 미리보기",
  "editor.pair.review.hunkAccept": "이 hunk 수락",
  "editor.pair.review.hunkReject": "이 hunk 취소",
  "editor.pair.review.previewHint": "읽기 전용 미리보기 — 수락 여부는 hunk 칩에서 전환.",
  "taskrec.detailTime": "작업 시간",
  "taskrec.detailResult": "결과",
  "editor.pair.status.branch": "git 브랜치",
  "editor.pair.cp.baseline": "베이스라인",
  "editor.pair.cp.lastSave": "마지막 수동 저장",
  "editor.pair.done.review": "생성 완료 —— 캔버스에서 검토",
  "editor.pair.done.applied": "적용됨",
  "editor.pair.done.inCanvas": "캔버스에서 검토",
  "editor.pair.done.rollbackHint": "⌘Z로 전체 롤백",
  "editor.pair.review.title": "AI 변경 검토",
  "editor.pair.review.hint": "빨강 = 교체 대상 · 초록 = AI 추가 · 청크별 ✓/✕",
  "editor.pair.review.apply": "모두 적용",
  "editor.pair.review.discard": "버리기",
  "editor.pair.status.idle": "✦ 페어 대기",
  "editor.pair.status.streaming": "✦ 생성 중 —— 캔버스로 스트리밍",
  "editor.pair.status.review": "✦ 검토 대기",
  "editor.pair.status.applied": "✦ 적용됨",
  "editor.pair.status.pair": "페어",
  "editor.pair.status.palette": "명령",
  "editor.pair.status.rollback": "롤백",
  "editor.pair.status.diag": "진단",
  "editor.pair.status.diagJump": "첫 진단으로 이동(해당 행을 선택해 인라인 페어를 바로 시작합니다)",
  "editor.pair.status.cp": "체크포인트 {n}",
  "editor.pair.cp.title": "체크포인트",
  "editor.pair.cp.empty": "베이스라인",
  "editor.pair.cp.justNow": "방금",
  "editor.pair.cp.minAgo": "{n}분 전",
  "editor.pair.cp.time": "{h}:{m}",
  "editor.pair.cp.hint": "⌘Z로 적용된 실행을 롤백",
  "editor.pair.cp.rollbackTo": "{label}(으)로 롤백",
  "editor.pair.lane.title": "페어 레인",
  "editor.pair.lane.toggle": "레인",
  "editor.pair.lane.plan": "계획",
  "editor.pair.lane.files": "변경 파일",
  "editor.pair.lane.pending": "검토 대기",
  "editor.pair.lane.streaming": "생성 중",
  "editor.pair.lane.approval": "승인 대기열",
  "editor.pair.lane.approvalHint":
    "교차 파일 작업은 메인 세션에서 시작하며 권한 프롬프트는 대화에서 대기열에 쌓입니다.",
  "editor.pair.lane.foot": "작은 편집은 인라인으로(⌘I); 여러 파일은 메인 세션으로.",
  "editor.palette.title": "에디터 팔레트",
  "editor.palette.placeholder": "⌘P 파일 / ⌘T 심볼 / ⇧⌘O 파일 내 — 접두사 @ # . 로 전환",
  "editor.palette.mode.files": "파일 · 인덱스",
  "editor.palette.mode.symbols": "워크스페이스 심볼 · 인덱스",
  "editor.palette.mode.infile": "이 파일의 심볼",
  "editor.palette.mode.cmds": "명령",
  "editor.palette.noIndex": "심볼 인덱스 없음 — 지식 패널에서 구축 가능",
  "editor.palette.empty": "일치 없음.",
  "editor.palette.ask": "이 심볼에 대해 디지털 엔티티에게 묻기",
  "editor.palette.askPrefill": "심볼 설명",
  "editor.palette.cmd.pair": "인라인 페어 전환（⌘I）",
  "editor.palette.cmd.save": "파일 저장（⌘S）",
  "editor.palette.cmd.explain": "AI: 선택 코드 설명",
  "editor.palette.cmd.refactor": "AI: 선택 코드 리팩터",
  "editor.palette.cmd.test": "AI: 선택에 테스트 추가",
  "editor.palette.cmd.fixDiag": "AI: 첫 진단 수정",
  "editor.palette.cmd.fixDiag.prompt": "이 진단을 수정 — 최소한의 올바른 변경을 제안해 줘.",
  "editor.palette.kbd.select": "선택",
  "editor.palette.kbd.open": "열기 / 이동",
  ...
  // ── 디자인 워크스페이스 ────────────────────────────────────
  "designWorkspace.currentRoot": "현재 · {root}",
  "designWorkspace.versionHistory": "버전 기록",
  "designWorkspace.noVersions": "아직 버전이 없습니다.",
  "designWorkspace.latest": "최신",
  ...
  "designWorkspace.agent": "디자인 에이전트",
  "designWorkspace.agentSilent": "조용히 실행",
  "designWorkspace.agentToggle": "디자인 에이전트 열기 또는 접기",
  "designWorkspace.quickFor": "빠른 작업 · {tab}",
  "designWorkspace.agentPrompt": "수정할 내용을 입력하세요…",
  "designWorkspace.selectionFix": "선택 영역 수정",
  "designWorkspace.selectionPrompt": "선택 영역에 적용할 수정을 입력하세요…",
  "designWorkspace.executeAction": "{action} 실행",
  "designWorkspace.exportVersion": "이 버전 내보내기",
  "designWorkspace.quoteToChat": "채팅에 인용",
  "designWorkspace.previewTitle": "UI 디자인 미리보기",
  "designWorkspace.exportPdf": "PDF 내보내기",
  "designWorkspace.tabPages": "시각 디자인",
  "designWorkspace.tabTokens": "디자인 시스템",
  "designWorkspace.tabQuality": "품질 및 리뷰",
  "designWorkspace.prototypeBasis": "기반 프로토타입",
  "designWorkspace.designSystem": "디자인 시스템",
  "designWorkspace.generateFromPrototype": "프로토타입에서 생성",
  "designWorkspace.runQuality": "품질 리뷰 실행",
  "designWorkspace.noDesign": "구체적인 프로토타입 버전과 디자인 시스템을 선택해 시각 디자인을 생성하세요.",
  "designWorkspace.tokensTitle": "토큰 표",
  "designWorkspace.componentsTitle": "컴포넌트 원자 라이브러리",
  "designWorkspace.noTokens": "이 버전에는 토큰 데이터가 없습니다.",
  "designWorkspace.noComponents": "이 버전에는 컴포넌트 목록이 없습니다.",
  "designWorkspace.qualityTitle": "품질 및 리뷰",
  "designWorkspace.findings": "지적 사항",
  "designWorkspace.runtimeChecks": "런타임 검사",
  "designWorkspace.reviewScore": "리뷰 점수",
  "designWorkspace.noQuality": "이 버전에서는 품질 리뷰를 실행하지 않았습니다.",
  "designWorkspace.locate": "위치 찾기",
  "designWorkspace.basedOn": "프로토타입 {version} 기반",
  "designWorkspace.driftRun": "드리프트 검사 실행",
  "designWorkspace.driftPass": "기준선 내",
  "designWorkspace.driftDetected": "드리프트 감지됨",
  "designWorkspace.driftScore": "드리프트 점수 {score}",
  ...
  "designWorkspace.tokensGroup.typography": "타이포그래피",
  "designWorkspace.tokensGroup.spacing": "간격",
  "designWorkspace.tokensGroup.radius": "반경",
  "designWorkspace.tokensGroup.shadow": "그림자",
  "designWorkspace.tokensGroup.motion": "모션",
  "designWorkspace.toastExported": "내보냄: {path}",
  "designWorkspace.toastExportFailed": "내보내기 실패: {error}",
  "designWorkspace.toastDriftDone": "드리프트 검사 완료(결정론적 0–100)",
  "designWorkspace.toastRevised": "수정 사항 적용 · 새 버전 생성(자동)",
  "designWorkspace.toastGenerated": "생성 완료 · 새 버전 추가됨",
  "designWorkspace.toastQualityDone": "품질 검토 완료",
  "prototypeWorkspace.setTitleSpec": "요구사항 문서",
  "prototypeWorkspace.specHint": "한 문장이면 충분합니다. 7개 섹션의 요구사항 문서로 확장됩니다.",
  "prototypeWorkspace.setTitleProto": "프로토타입",
  "prototypeWorkspace.setTitleReport": "검수 보고서",
  "prototypeWorkspace.todosTitle": "확인 대기",
  "prototypeWorkspace.confirmItem": "✓ 확인",
  "prototypeWorkspace.versionCapProto": "버전 · 1 버전 = 1 세트(명세 + 프로토타입 + 보고서)",
  "prototypeWorkspace.scopeHint": "버전 {version}",
  ...
  "prototypeWorkspace.reportHealRounds": "자가 치유 라운드(≤3)",
  "prototypeWorkspace.pendingCount": "확인 대기 {count}개",
  "prototypeWorkspace.pendingCleared":
    "확인 대기 항목이 모두 확인되었습니다 —— 명세가 확정되어 프로토타입을 생성할 수 있습니다.",
  "prototypeWorkspace.pendingHint": "먼저 확인 대기 항목을 모두 확인하세요",
  "prototypeWorkspace.confirmedItem": "확인됨",
  "prototypeWorkspace.toastVerified": "수용 검사 완료",
  ...
  "designWorkspace.atomSecondary": "보조 작업",
  "designWorkspace.atomGhost": "고스트 버튼",
  "designWorkspace.atomInput": "입력 플레이스홀더",
  "designWorkspace.atomInputFocus": "포커스",
  "designWorkspace.atomInputError": "오류",
  "designWorkspace.basisSwitched": "기반 프로토타입 전환됨 · {label}",
  "designWorkspace.atomTag": "태그",
  "designWorkspace.atomTagWarn": "경고",
  "designWorkspace.atomCardTitle": "카드 제목",
  "designWorkspace.atomCardBody": "카드 본문 예시 텍스트.",
  "designWorkspace.triggerChainTitle": "트리거 체인",
  "designWorkspace.triggerChain":
    "생성과 각 수정 시 design.lint(taste / anti-slop / a11y)와 렌더링 후 검사를 자동 실행하며, 「품질 검토 실행」으로 옵트인 리뷰 게이트(≤3회)를 추가 실행해 결과가 meta.verification에 기록됩니다.",
  "designWorkspace.reviewRounds": "검토 라운드",
  "designWorkspace.evidence": "근거",
  "designWorkspace.selectionCopy": "이 섹션 문구 수정",
  "designWorkspace.selectionSpacing": "여백 조정",
  "designWorkspace.quickPagesOne": "히어로 문구를 절제되게 변경",
  "designWorkspace.quickPagesTwo": "상태 필터 추가",
  "designWorkspace.quickTokensOne": "모션 토큰 단계 추가",
  "designWorkspace.quickTokensTwo": "다크 분기 추가",
  "designWorkspace.quickQualityOne": "대비 지적 사항 수정",
  "designWorkspace.quickQualityTwo": "리뷰 게이트 다시 실행",
  "designWorkspace.progressGenerate": "프로토타입에서 비주얼 생성 중…",
  "designWorkspace.progressSaved": "비주얼 버전이 저장되었습니다",
  "designWorkspace.progressTokensExtract": "브랜드 토큰 추출 중…",
  ...
  "designWorkspace.status.ready": "준비됨",
  "designWorkspace.status.verified": "검증됨",
  "designWorkspace.vbadgeNote": "{findings}건 · 검토 {review}",
  "designWorkspace.qualityMeta": "버전 {version} · 테마 {theme} · 생성 {time}",
  ...
  "designWorkspace.catalog.brutalist-contrast": "브루탈리스트 대비",
  "designWorkspace.catalog.swiss-international": "스위스 인터내셔널",
  "designWorkspace.catalog.terminal-mono": "터미널 고정폭",
  "designWorkspace.catalog.glass-morphism": "글래스모피즘",
  "designWorkspace.catalog.soft-neumorphic": "소프트 뉴모픽",
  "designWorkspace.catalog.warm-handcrafted": "따뜻한 핸드크래프트",
  "prototypeWorkspace.tabSpec": "요구사항 문서",
  "prototypeWorkspace.tabPrototype": "인터랙티브 프로토타입",
  "prototypeWorkspace.tabReport": "인수 보고서",
  "prototypeWorkspace.requirementPrompt": "요구사항을 입력하세요. 한 문장도 충분합니다…",
  "prototypeWorkspace.generateSpec": "요구사항 문서 생성",
  "prototypeWorkspace.materialize": "요구사항 확정 후 프로토타입 생성",
  "prototypeWorkspace.noSpec": "먼저 요구사항 문서를 생성하세요.",
  "prototypeWorkspace.specViewDoc": "문서",
  "prototypeWorkspace.specViewSlides": "슬라이드",
  "prototypeWorkspace.slidesPrev": "이전 슬라이드",
  "prototypeWorkspace.slidesNext": "다음 슬라이드",
  "prototypeWorkspace.slidesPage": "{current} / {total}",
  "prototypeWorkspace.slidesExportHtml": "HTML 내보내기",
  "prototypeWorkspace.slidesExportPdf": "PDF 내보내기",
  "prototypeWorkspace.slidesExported": "내보냈습니다: {path}",
  "prototypeWorkspace.slidesExportFailed": "내보내기 실패: {error}",
  "prototypeWorkspace.slidesRemoteBlocked": "원격 이미지 {count}장이 오프라인 보안 정책에 의해 차단되었습니다.",
  "prototypeWorkspace.briefGenerate": "구현 브리프 생성",
  "prototypeWorkspace.briefInject": "세션에 주입",
  "prototypeWorkspace.briefOk": "브리프 생성됨: {path}",
  "prototypeWorkspace.briefGaps": "브리프 중단 — 정의되지 않은 화면 참조: {gaps}",
  ...
  "prototypeWorkspace.tabArch": "기술 아키텍처",
  "prototypeWorkspace.setTitleArch": "구조",
  "prototypeWorkspace.archGenerate": "기술 아키텍처 문서 생성",
  "prototypeWorkspace.archRegenerate": "기술 아키텍처 문서 재생성",
  "prototypeWorkspace.archOk": "기술 아키텍처 문서가 생성되었습니다",
  "prototypeWorkspace.archLocked": "프로토타입 검수를 통과해야 기술 아키텍처 문서를 생성할 수 있습니다",
  ...
  "prototypeWorkspace.runWalkthrough": "인수 점검 실행",
  "prototypeWorkspace.noReport": "이 버전에서는 인수 검증을 실행하지 않았습니다.",
  "prototypeWorkspace.passed": "통과",
  "prototypeWorkspace.failed": "실패",
  "prototypeWorkspace.fixFinding": "이 항목 수정",
  "prototypeWorkspace.executeInstruction": "프로토타입 action {action}을 실행하고 의미 계약을 유지합니다.",
  "prototypeWorkspace.selectionCopy": "이 요소 문구 수정",
  "prototypeWorkspace.selectionSpacing": "이 요소 여백 조정",
  "prototypeWorkspace.quickSpecOne": "인수 기준 추가",
  "prototypeWorkspace.quickSpecTwo": "페이지 목록 정리",
  "prototypeWorkspace.quickProtoOne": "상태 필터 추가",
  "prototypeWorkspace.quickProtoTwo": "밀집 레이아웃 개선",
  "prototypeWorkspace.quickReportOne": "실패한 검사 수정",
  "prototypeWorkspace.quickReportTwo": "빈 상태 문구 개선",
  ...
  "prototypeWorkspace.quickReportThree": "KPI 추세 메모 추가",
  ...
  "specs.openFailed": "spec 문서를 열지 못했습니다",
  "specs.issue.section": "구조 검사",
  "specs.issue.duplicateId": '노드 id "{id}"는 이미 {other}에서 사용 중입니다',
  "specs.issue.unknownType": 'type "{type}"가 폐쇄 어휘 범위 밖입니다',
  "specs.issue.unknownStatus": 'status "{status}"가 폐쇄 어휘 범위 밖입니다',
  "specs.issue.danglingLink": '{kind} → "{id}"가 존재하지 않는 노드를 가리킵니다',
  "specs.issue.independentArchitecture": "독립 아키텍처 노드(제품 설계 상류 없음) — 합법",
  "specs.issue.archParentNotProductDesign": 'parent "{parent}"는 {type} 노드이며 product-design이 아닙니다',
  "specs.issue.chainHalf": "기술 설계 미생성 — 합법적인 중간 상태",
  "specs.issue.tasksParentMismatch": 'tasks의 parent "{parent}"는 같은 디렉터리의 설계 노드여야 합니다',
  "specs.issue.tasksNoParent": "parent 없는 tasks 노드 — <dir>#tasks 규약을 따라야 합니다",
  "specs.issue.artifactEscapesRoot": 'artifacts 항목 "{artifact}"가 워크스페이스 루트를 벗어났습니다',
  "specs.issue.looseFile": "사용 가능한 frontmatter 없는 markdown 파일 — 그래프 노드로 미등록",
};
