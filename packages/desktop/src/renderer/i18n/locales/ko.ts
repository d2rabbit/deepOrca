...
export const ko: Record<MessageKey, string> = {
  ...
  "deck.placeholder.theme": "Deck 테마는 E2 테마 작업에서 추가됩니다. 현재는 Liquid Glass만 제공됩니다.",
  "deck.placeholder.notifications": "알림은 오버레이 스택（E3）에서 추가됩니다.",
  "deck.placeholder.e3": "이 모듈은 E3에서 추가됩니다. 지금은 클래식 레이아웃을 사용하세요.",
};
