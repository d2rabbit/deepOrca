...
export const ko: Record<MessageKey, string> = {
  ...
  // ── Orca Deck（실험 레이아웃）─────────────────────────────
  "settings.appearance.layout": "레이아웃",
  "layout.classic": "기본 (Classic)",
  "layout.deck.badge": "실험",
  "layout.switch.hint": "레이아웃을 전환하면 창이 다시 로드됩니다. 세션과 설정은 영향을 받지 않습니다.",
  "deck.backToClassic": "클래식으로 돌아가기",
  "deck.goal.empty": "진행 중인 목표 없음",
  "deck.stage.badge": "실험 · Orca Deck",
  "deck.stage.empty":
    "진행 중인 목표가 없습니다. 새 목표를 발행(⌘N)하거나 워크숍 월에서 세션을 선택하세요 — 단계, 승인, 개입이 모두 여기에 모입니다.",
  "deck.dock.notifications": "알림",
  "deck.dock.tape": "기록",
  "deck.dock.theme": "테마",
  "deck.dock.settings": "설정",
  "deck.dock.files": "파일",
  "deck.dock.changes": "변경",
  "deck.dock.processes": "프로세스",
  "deck.dock.assets": "자산",
  "deck.dock.review": "검토",
  "deck.dock.sources": "지식 소스",
  "deck.dock.ledger": "원장",
  "deck.dock.tree": "작업 트리",
  "deck.dock.plugins": "플러그인",
  "deck.dock.checkpoints": "체크포인트",
  "deck.dock.editor": "편집기",
  "deck.dock.shortcuts": "단축키",
  "deck.dock.floor": "워크숍",
  "deck.dock.newGoal": "새 목표",

  // ── Orca Deck E1/E2（코어 루프 + 기능 패널）────────────────
  "deck.cc.title": "제어 센터",
  "deck.cc.duration": "시간",
  "deck.cc.cost": "비용",
  "deck.cc.context": "컨텍스트",
  "deck.cc.tokens": "토큰",
  "deck.cc.commands": "내 명령",
  "deck.cc.commandsEmpty": "Deck에서 전송한 명령이 아직 없습니다.",
  "deck.cc.events": "상태 스트림",
  "deck.cc.eventsEmpty": "엔진 이벤트가 아직 없습니다.",
  "deck.steps.title": "단계",
  "deck.pending.title": "승인 대기",
  "deck.pending.allow": "허용",
  "deck.pending.deny": "거부",
  "deck.pending.always": "항상 허용",
  "deck.pending.submit": "제출",
  "deck.composer.placeholder": "명령 입력…（⏎ 전송）",
  "deck.tape.empty": "메시지가 아직 없습니다.",
  "deck.loading": "로드 중…",
  "deck.noSession": "진행 중인 목표가 없습니다. 워크숍에서 세션을 선택하세요.",
  "deck.floor.empty": "이 워크스페이스에 세션이 없습니다.",
  "deck.checkpoints.empty": "이 세션에 체크포인트가 없습니다.",
  "deck.checkpoints.restoreCode": "코드 복원",
  "deck.checkpoints.restoreChat": "대화 복원",
  "deck.ledger.total": "총 토큰",
  "deck.ledger.cacheHit": "캐시 적중",
  "deck.ledger.sessions": "세션 수",
  "deck.tree.empty": "작업 트리가 아직 없습니다.",
  "deck.tree.nodes": "{count}개 노드",
  "deck.files.empty": "워크스페이스가 비어 있습니다.",
  "deck.changes.noRepo": "git 저장소가 아닙니다.",
  "deck.changes.staged": "스테이지됨",
  "deck.changes.unstaged": "변경 사항",
  "deck.changes.stage": "스테이지",
  "deck.changes.unstage": "스테이지 해제",
  "deck.changes.discard": "버리기",
  "deck.changes.discardConfirm": "한 번 더 클릭하면 버립니다",
  "deck.changes.clean": "작업 트리가 깨끗합니다.",
  "deck.changes.commitPlaceholder": "커밋 메시지…",
  "deck.changes.commit": "커밋",
  "deck.processes.empty": "이 세션에 백그라운드 프로세스가 없습니다.",
  "deck.processes.noOutput": "（출력 없음）",
  "deck.plugins.empty": "구성된 MCP 서버가 없습니다.",
  "deck.plugins.enable": "활성화",
  "deck.plugins.disable": "비활성화",
  "deck.review.unavailable": "코드 검토 CLI를 사용할 수 없습니다.",
  "deck.review.run": "검토 실행",
  "deck.review.running": "검토 중…",
  "deck.assets.empty": "디자인 자산이 아직 없습니다.",
  "deck.cmd.title": "커맨드 레이어",
  "deck.cmd.placeholder": "입력하여 명령 검색 — 접두어 › 는 모듈만",
  "deck.cmd.empty": "일치하는 명령이 없습니다.",
  "deck.cmd.interrupt": "실행 중인 목표 중단",
  "deck.notif.empty": "아직 알림이 없습니다 — 엔진 이벤트가 여기에 표시됩니다.",
  "deck.notif.clear": "지우기",
  "deck.theme.name.liquid": "Liquid Glass",
  "deck.theme.name.flat": "플랫",
  "deck.theme.name.glass": "글래스모피즘",
  "deck.theme.name.neu": "뉴모피즘",
  "deck.theme.name.clay": "클레이모피즘",
  "deck.theme.name.vern": "버니큘러 1997",
  "deck.settings.theme": "테마",
  "deck.settings.language": "언어",
  "deck.settings.layout": "레이아웃",
  "deck.settings.layoutDeck": "Orca Deck (실험적)",
  "deck.settings.layoutHint": "전환하면 창이 다시 로드됩니다. 세션은 유지됩니다.",
  "deck.editor.pick": "왼쪽 파일 트리에서 편집할 파일을 선택…",
  "deck.editor.save": "저장",
  "deck.editor.saved": "저장됨",
  "deck.editor.dirty": "저장 안 됨",
  "deck.editor.binary": "바이너리 파일은 편집하지 않습니다.",
  "deck.editor.loadError": "파일을 읽을 수 없습니다.",
  "deck.shortcuts.global": "전역",
  "deck.shortcuts.modules": "모듈",
  "deck.shortcuts.closeTop": "최상위 오버레이 닫기",
  "deck.shortcuts.clearStack": "모든 오버레이 닫기",
  "deck.metrics.title": "실험 메트릭",
  "deck.metrics.boots": "부팅 횟수(클래식 / Deck)",
  "deck.metrics.switches": "전환 횟수(→ Deck / → 클래식)",
  "deck.metrics.funnel": "핵심 경로(질문→승인→diff)",
  "deck.metrics.classic": "클래식",
  "deck.metrics.deck": "Orca Deck",
  "deck.metrics.runs": "완주 {count}회",
  "deck.metrics.avgClicks": "평균 {count}클릭",
  ...
  "deck.sources.back": "지식 소스",
  "deck.sources.count": "콘텐츠량",
  "deck.sources.lastSync": "마지막 동기화",
  "deck.sources.detail": "상세",
  "deck.sources.rebuild": "인덱스 재구축",
  "deck.sources.update": "위키 업데이트",
  "deck.onboard.title": "목표를 주면, 나머지는 워크오더로",
  "deck.onboard.hint": "이것은 채팅창이 아닙니다: agent가 워크오더를 내고, 당신이 승인하면 시공합니다.",
  "deck.onboard.item1": "⌘K — 커맨드 레이어에서 모듈·골·테마 한 번에",
  "deck.onboard.item2": "워크오더는 당신의 것 — 계획·승인·개입은 스텝 보드에서",
  "deck.onboard.item3": "Space는 브레이크 — 언제든 동결, 현장 보존",
  "deck.onboard.start": "시작",
  "deck.autonomy.label": "자율도",
  "deck.autonomy.full": "풀 오토",
  "deck.autonomy.key": "핵심 확인",
  "deck.autonomy.each": "매 단계 확인",
  "deck.autonomy.hint": "권한 요청에 대한 응답 방침(풀 오토에서도 고위험은 차단)",
  "deck.gate.auto": "자동",
  "deck.gate.confirmBefore": "시작 전 확인",
  "deck.gate.confirmDone": "완료 시 확인",
  "deck.gate.card.done": "단계 “{step}” 완료 — 계속할까요?",
  "deck.gate.card.before": "단계 “{step}” 시작 예정 — 확인?",
  "deck.gate.resume": "계속",
  "deck.gate.stay": "동결 유지",
  "deck.draft.namePlaceholder": "목표를 입력…",
  "deck.draft.stepPlaceholder": "단계…",
  "deck.draft.addStep": "단계 추가",
  "deck.draft.stamp": "승인 후 발행",
  "deck.steps.gate": "게이트",
  "deck.steps.strike": "취소선",

  // ── Deck E8: stage tabs + full-body module views ─────────
  "deck.tab.workOrder": "작업 지시",
  "deck.tab.open": "탭에서 열기",
  "deck.tab.close": "탭 닫기",
  "deck.opFailed": "작업 실패: {error}",
  "deck.tree.pick": "왼쪽에서 작업 트리를 선택하세요.",
  "deck.tree.branches": "브랜치 {count}개",
  "deck.tree.archived": "보관됨",
  "deck.tree.archive": "보관",
  "deck.tree.unarchive": "보관 해제",
  "deck.tree.active": "현재",
  "deck.tree.abandoned": "포기됨",
  "deck.tree.switch": "전환",
  "deck.tree.merge": "병합",
  "deck.tree.abandon": "포기",
  "deck.tree.abandonConfirm": "한 번 더 클릭하면 확인",
  "deck.tree.fork": "브랜치 분기",
  "deck.tree.forkWhy": "분기 사유(필수)…",
  "deck.tree.reflog": "작업 로그",
  "deck.tree.selectNode": "노드를 클릭해 상세 보기",
  "deck.tree.artifacts": "아티팩트 {count}개",
  ...
  "deck.sources.roleFocus": "포커스",
  "deck.sources.roleCallers": "호출자",
  "deck.sources.roleCallees": "호출 대상",
  "deck.sources.graphTruncated": "결과가 잘렸습니다",
  ...
  "deck.sources.rebuildAll": "모두 재구축",
  "deck.sources.rebuilding": "재구축 중…",
  "deck.sources.graphReady": "그래프 구축됨",
  "deck.sources.noGraph": "그래프 없음",
  "deck.review.runFull": "review.full 실행",
  "deck.review.graphReady": "리스크 그래프 구축됨",
  "deck.review.graphUnbuilt": "리스크 그래프 미구축",
  "deck.review.history": "이 세션의 실행 기록",
  "deck.review.findings": "발견 {count}건",
  "deck.review.noRuns": "아직 실행 기록이 없습니다 — 검토를 시작하세요.",
  "deck.review.failed": "실행 실패: {error}",
  "deck.review.risk": "리스크 그래프: 변경 노드 {count}개",
  "deck.review.noFindings": "발견 없음 — 모두 통과.",
  "deck.review.advisory": "제안",
  "deck.review.finding": "발견",
  ...
  "deck.question.title": "에이전트 질문",
  "deck.question.multi": "다중 선택",
  "deck.question.textPlaceholder": "답변을 입력하세요…",
  "deck.question.decline": "건너뛰기 — 알아서 결정",
  "deck.cc.directive": "지시 내리기",
  "deck.cc.directivePlaceholder": "선택한 대상에 개입…",
  "deck.cc.targetGoal": "목표",
  "deck.goal.steps": "{done}/{total} 단계",
  "deck.goal.frozen": "⏸ 동결됨",
  "deck.goal.status.live": "진행 중",
  "deck.goal.status.done": "납품 완료",
  "deck.goal.status.idle": "대기 중",
  "deck.goal.status.attention": "입력 대기",
  "deck.floor.status.live": "진행 중",
  "deck.floor.status.done": "납품 완료",
  "deck.floor.status.failed": "실패",
  "deck.floor.status.attention": "확인 필요",
  "deck.floor.archive": "보관",
  ...
  "deck.onboard.auto2": "매 단계 시작 전 확인",
  "deck.onboard.recommended": "권장",
  "deck.cmd.zen": "집중 모드 전환",
  "deck.steps.struck": "취소선 그음",
  "deck.steps.unstrike": "단계 복원",
  "deck.steps.expand": "펼치기",
  "deck.steps.strikeHint": "더블 클릭으로 이 단계에 취소선",
  "deck.steps.struckHint": "더블 클릭으로 이 단계 복원",
  "deck.steps.gateHint": "클릭하여 게이트 전환 · 자율도 기본값 덮어쓰기",
  "deck.autonomy.scope": "· 게이트 미설정 단계는 이 레벨을 따름",
  "deck.shortcuts.cc": "제어 센터",
  "deck.shortcuts.zen": "집중 모드",
  "deck.shortcuts.brake": "브레이크 / 재개",
  "deck.shortcuts.stepNav": "단계 이동",
  "deck.shortcuts.autonomy": "자율도 레벨",
  "deck.shortcuts.send": "명령 보내기",
  "deck.context.title": "컨텍스트 분해",
  "deck.context.active": "활성 컨텍스트",
  "deck.context.threshold": "압축 임계값",
  "deck.context.prompt": "프롬프트 tokens(누적)",
  "deck.context.completion": "완료 tokens(누적)",
  "deck.context.watermark": "컨텍스트 수위 · {pct}%",
  "deck.context.watermarkHint": "{threshold} 부근에서 압축 발동 (모델: {model})",
  "deck.context.cache": "프롬프트 캐시 적중률 · {pct}%",
  "deck.context.cacheHint": "적중 {hit} · 미스 {miss}",
  "deck.ledger.byModel": "모델별",
  "deck.ledger.bySession": "작업 지시별",
  "deck.ledger.reqs": "{count}회 요청",
  "deck.plugins.tools": "도구 · {count}",
  "deck.plugins.noTools": "보고된 도구가 아직 없습니다 — 서버가 아직 시작 중일 수 있습니다.",
  "deck.plugins.disabledState": "비활성화됨",
  "deck.assets.updated": "업데이트",
};
