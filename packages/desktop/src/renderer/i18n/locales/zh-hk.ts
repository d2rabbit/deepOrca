...
export const zhHK: Record<MessageKey, string> = {
  ...
  "builtin-plugin.react-native-dev.name": "React Native 開發",
  "builtin-plugin.react-native-dev.desc": "RN 開發技能（Expo + Callstack）+ Expo MCP。",
  ...
  "builtin-plugin.dotnet-dev.desc": "Microsoft 官方 .NET 技能（12 域）。跨平台。",
  "builtin-plugin.qt-dev.name": "Qt/KDE 開發",
  "builtin-plugin.qt-dev.desc": "Qt Group 官方技能（7 個）+ Qt 文件 MCP。跨平台。",
  "builtin-plugin.deepin-dev.name": "deepin/UOS 開發",
  "builtin-plugin.deepin-dev.desc": "統信官方 deepin 桌面開發技能（4 個）。僅 Linux。",
