...
export const zhHK: Record<MessageKey, string> = {
  ...
  "builtin-plugin.flutter-dev.name": "Flutter 開發插件",
  "builtin-plugin.flutter-dev.desc": "Flutter/Dart 開發專家技能包，涵蓋架構、測試、路由、本地化、HTTP、FFI 等。",
  "builtin-plugin.codegraph.name": "CodeGraph",
  "builtin-plugin.codegraph.desc": "預索引的程式碼知識圖譜——符號導航、呼叫關係與依賴圖，實現即時檢索。",
  "builtin-plugin.code-review.name": "程式碼審查",
  "builtin-plugin.code-review.desc": "AI 程式碼審查（Open Code Review）+ 風險評分與影響範圍分析（code-review-graph）。",
  "builtin-plugin.gitmcp.name": "GitMCP",
  "builtin-plugin.gitmcp.desc": "將任意 GitHub 倉庫轉為 Agent 可查詢的 MCP 知識源。",
  "builtin-plugin.openwiki.name": "OpenWiki",
  "builtin-plugin.openwiki.desc": "自動生成並維護專案 Wiki，供 Agent 引用。",
  "builtin-plugin.browser-skill.name": "瀏覽器技能",
  "builtin-plugin.browser-skill.desc": "驅動使用者的真實 Chromium 瀏覽器——造訪頁面、填寫表單、抓取資料、回歸測試 UI。",
  ...
  "builtin-plugin.android-dev.desc": "官方 Android 技能（14 個）+ Android CLI 整合",
  "builtin-plugin.harmonyos-dev.name": "HarmonyOS 開發",
  "builtin-plugin.harmonyos-dev.desc": "HarmonyOS 技能 + DevEco CLI MCP",
  "builtin-plugin.react-native-dev.name": "React Native 開發",
  "builtin-plugin.react-native-dev.desc": "RN 技能（Expo + Callstack）+ Expo MCP",
  "builtin-plugin.browser.name": "瀏覽器與聯網",
  "builtin-plugin.browser.desc": "Chrome 操控 + 網絡搜尋 + 聯網策略",
