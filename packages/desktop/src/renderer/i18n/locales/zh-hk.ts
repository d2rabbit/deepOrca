...
export const zhHK: Record<MessageKey, string> = {
  ...
  "builtin-plugin.code-intelligence.name": "程式碼智能",
  ...
  "builtin-plugin.android-dev.desc": "Google 官方 Android 開發技能（20 個）+ Android CLI。",
  "builtin-plugin.harmonyos-dev.name": "HarmonyOS 開發",
  "builtin-plugin.harmonyos-dev.desc": "鴻蒙開發技能 + DevEco CLI MCP。",
  "builtin-plugin.expo-dev.name": "Expo 開發",
  "builtin-plugin.expo-dev.desc": "Expo/RN 開發技能 + Expo MCP。源自 expo/skills。",
  "builtin-plugin.dotnet-dev.name": ".NET 開發",
  "builtin-plugin.dotnet-dev.desc": "Microsoft 官方 .NET 技能（96 個）。跨平台。",
  "builtin-plugin.qt-dev.name": "Qt/KDE 開發",
  "builtin-plugin.qt-dev.desc": "Qt Group 官方技能（12 個）。跨平台。",
  "builtin-plugin.apple-dev.name": "Apple 平台開發",
  "builtin-plugin.apple-dev.desc": "Apple Xcode 27 第一方技能 + 社群精選。僅 macOS。",
  "builtin-plugin.deepin-dev.name": "deepin/UOS 開發",
  "builtin-plugin.deepin-dev.desc": "統信官方 deepin 桌面開發技能。僅 Linux。",
  "builtin-plugin.design.name": "設計生成",
  "builtin-plugin.design.desc": "DeepDesign + PM-Designer + taste 設計紀律。",
  "builtin-plugin.documentation.name": "知識與文件",
  "builtin-plugin.documentation.desc": "GitMCP + OpenWiki + 行為記憶（activity-frames）。",
  "builtin-plugin.browser.name": "瀏覽器與聯網",
  "builtin-plugin.browser.desc": "真實 Chrome 操控 + WebSearch + 智慧聯網策略。",
  "builtin-plugin.security.name": "安全掃描",
  "builtin-plugin.security.desc": "SkillSpector — AI skill/MCP 安全掃描器（68 漏洞模式）。",
  "builtin-plugin.skill-tools.name": "技能工具",
  "builtin-plugin.skill-tools.desc": "編寫、消化和管理 Agent 技能。",
  "builtin-plugin.deeporca.name": "DeepOrca",
  "builtin-plugin.deeporca.desc": "產品原生技能與範本——自參考文件和 Bento 投影片生成。",
  ...
  "wiki.notInstalled": "未找到 openwiki CLI。安裝後即可生成項目 Wiki：",
  "wiki.generate": "生成 Wiki",
  "wiki.generating": "生成中…",
  "wiki.update": "增量更新",
  "wiki.updating": "更新中…",
  "wiki.noPages": "暫無 Wiki 頁面。點擊「生成 Wiki」構建項目知識圖譜。",
  "wiki.done": "Wiki 生成完成",
