...
export const zh: Record<MessageKey, string> = {
  ...
  "editor.agent.title": "问数字体",
  "editor.agent.ask": "就此选区提问",
  "editor.agent.placeholder": "对这段选区要做什么？（⌘⏎ 发送）",
  "editor.agent.hint": "在会话中执行——回复将流式输出到会话。",
  "editor.agent.send": "发送",
  "editor.agent.sent": "✓ 已发送到会话",
  "editor.agent.running": "数字体执行中…",
  "editor.agent.apply": "应用到选区",
  "editor.agent.toChat": "到会话",
  ...
  "editor.diagnostics.title": "问题",
  "editor.diagnostics.empty": "该文件未检测到问题。",
