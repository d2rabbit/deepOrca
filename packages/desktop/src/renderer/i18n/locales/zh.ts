...
export const zh: Record<MessageKey, string> = {
  ...
  "prototypeWorkspace.specViewPd": "提示词",
  "prototypeWorkspace.pdRegen": "重算 pd-design",
  "prototypeWorkspace.pdRegenHint": "按当前 PRD 重新蒸馏 pd-design.md（将重置派生的原型产物）",
  "prototypeWorkspace.pdRegenDone": "pd-design.md 已重算",
  "prototypeWorkspace.progressPdDesign": "正在蒸馏 pd-design 提示词文档…",
  "prototypeWorkspace.progressPdDesignSaved": "pd-design.md 已保存",
  "prototypeWorkspace.progressPdDesignDegraded": "pd-design 蒸馏失败——已回退为按需求文档直驱生成",
