...
export const ja: Record<MessageKey, string> = {
  ...
  "builtin-plugin.code-intelligence.name": "コードインテリジェンス",
  ...
  "builtin-plugin.android-dev.desc": "公式 Android スキル（20 個）+ Android CLI。",
  "builtin-plugin.harmonyos-dev.name": "HarmonyOS 開発",
  "builtin-plugin.harmonyos-dev.desc": "HarmonyOS スキル + DevEco CLI MCP。",
  "builtin-plugin.expo-dev.name": "Expo 開発",
  "builtin-plugin.expo-dev.desc": "Expo/RN スキル + Expo MCP。expo/skills より。",
  "builtin-plugin.dotnet-dev.name": ".NET 開発",
  "builtin-plugin.dotnet-dev.desc": "Microsoft 公式 .NET スキル（96 個）。クロスプラットフォーム。",
  "builtin-plugin.qt-dev.name": "Qt/KDE 開発",
  "builtin-plugin.qt-dev.desc": "Qt Group 公式スキル（12 個）。クロスプラットフォーム。",
  "builtin-plugin.apple-dev.name": "Apple プラットフォーム開発",
  "builtin-plugin.apple-dev.desc": "Apple Xcode 27 公式スキル + コミュニティ。macOS 専用。",
  "builtin-plugin.deepin-dev.name": "deepin/UOS 開発",
  "builtin-plugin.deepin-dev.desc": "公式 deepin デスクトップスキル。Linux 専用。",
  "builtin-plugin.design.name": "デザイン生成",
  "builtin-plugin.design.desc": "DeepDesign + PM-Designer + taste デザイン原則。",
  "builtin-plugin.documentation.name": "ナレッジ & ドキュメント",
  "builtin-plugin.documentation.desc": "GitMCP + OpenWiki + 行動メモリ（activity-frames）。",
  "builtin-plugin.browser.name": "ブラウザとネットアクセス",
  "builtin-plugin.browser.desc": "Chrome 操作 + Web 検索 + アクセス戦略。",
  "builtin-plugin.security.name": "セキュリティスキャン",
  "builtin-plugin.security.desc": "SkillSpector — AI スキル/MCP セキュリティスキャナー（68 脆弱性パターン）。",
  "builtin-plugin.skill-tools.name": "スキルツール",
  "builtin-plugin.skill-tools.desc": "Agent スキルの作成、消化、管理。",
  "builtin-plugin.deeporca.name": "DeepOrca",
  "builtin-plugin.deeporca.desc": "製品ネイティブスキルとテンプレート — 自己参照ドキュメントと Bento スライド生成。",
