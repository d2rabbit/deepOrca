...
export const ja: Record<MessageKey, string> = {
  ...
  "builtin-plugin.react-native-dev.name": "React Native 開発",
  "builtin-plugin.react-native-dev.desc": "RN スキル（Expo + Callstack）+ Expo MCP。",
  ...
  "builtin-plugin.dotnet-dev.desc": "Microsoft 公式 .NET スキル（12 ドメイン）。クロスプラットフォーム。",
  "builtin-plugin.qt-dev.name": "Qt/KDE 開発",
  "builtin-plugin.qt-dev.desc": "Qt Group 公式スキル（7 個）+ Qt ドキュメント MCP。クロスプラットフォーム。",
  "builtin-plugin.deepin-dev.name": "deepin/UOS 開発",
  "builtin-plugin.deepin-dev.desc": "公式 deepin デスクトップスキル（4 個）。Linux 専用。",
