...
export const ja: Record<MessageKey, string> = {
  ...
  "designTheme.stageLabel": "フェーズ",
  "designTheme.stagePlaceholder": "例: フェーズ1",
  "designTheme.inheritsFrom": "継承元",
  "designTheme.references": "参照",
  "designTheme.missingTheme": "テーマは削除済み",
  "designTheme.newTheme": "テーマを作成",
  "designTheme.themeTitlePlaceholder": "テーマ名（例: ログイン）",
  "designTheme.renameTheme": "テーマ名を変更",
  "designTheme.deleteThemeHint": "テーマを削除（PRD は削除されず関連付けのみ解除）",
  "designTheme.confirmDelete": "削除を確認",
  ...
  "msg.refKind.review": "レビュー",
  "msg.refKind.file": "ファイル",
  "msg.refKind.dir": "フォルダー",
  "msg.refKind.cmd": "コマンド",
  "msg.refKind.skill": "スキル",
  "msg.refKind.design": "UIデザイン",
  "msg.refKind.prototype": "プロトタイプ",
  ...
  "theme.neumorph": "ソフトUI（ニューモーフィズム）",
  "theme.raw": "素のまま（ウェブ・ブルータリズム）",
  "theme.neobrutal": "ネオブルータリズム",
  "theme.minimal": "ミニマル",
  "theme.clay": "クレイ",
  "theme.geocities": "90年代ホームページ",
  "theme.y2k": "Y2K（クローム）",
  "theme.skeuo": "スキューモーフィズム（素材）",
  "decision.default": "既定",
  "decision.allow": "許可",
  "decision.ask": "確認",
  "decision.deny": "拒否",
  ...
  "taskhub.forkMode.worktree": "worktree サンドボックス",
  "taskhub.forkMode.branch": "独立ブランチ（git 連動）",
  "taskhub.forkMode.worktreeNote": "サンドボックスは .deeporca/task-trees 配下 —— ワークスペースストア内の隔離。",
  "taskhub.forkMode.branchNote":
    "git ブランチ + リポジトリ外の一時 worktree 检出 —— ファイル変更は構造的に隔離され、上流ワークスペースに影響しません。",
  "taskhub.mergeGo": "マージ",
  "taskhub.merged": "マージ済み",
  "taskhub.mergeConflicts": "{n} 件の成果物競合 —— 表示のみ、自動解決なし",
  "taskhub.legend.session": "セッション主タスク",
  "taskhub.legend.fork": "fork ブランチ（↔ git ブランチ）",
  "taskhub.legend.side": "並行タスク",
  "taskhub.legend.abandoned": "abandoned フェード",
  "taskhub.legend.merge": "merge 線",
  "taskhub.all": "すべて",
  ...
  "taskhub.status.interrupted": "中断済み",
  "taskhub.detail.command": "コマンド",
  "taskhub.detail.file": "ファイル",
  "taskhub.detail.link": "リンク",
  "taskhub.detail.query": "検索",
  "taskhub.detail.content": "内容",
  "taskhub.detail.change": "変更",
  "taskhub.detail.questions": "質問",
  "taskhub.detail.plan": "計画",
  "taskhub.detail.reply": "応答",
  "taskhub.detail.interruptedNote": "この呼び出しは完了前に中断され、結果は記録されていません。",
  ...
  "app.name": "DeepOrca",
  "settings.tab.entities": "デジタルエンティティ",
  "settings.entities.title": "デジタルエンティティ",
  "settings.entities.intro":
    "製品に同梱される内蔵デジタルエンティティ（自律動作するデジタルワーカー）——それぞれが実際のバックグラウンドパイプラインに対応します。カスタムエンティティは未開放です。",
  "settings.entities.builtin": "内蔵",
  "settings.entities.customSoon": "カスタムデジタルエンティティは今後のバージョンで開放予定です。",
  "settings.entities.arch.name": "アーキテクト分析",
  "settings.entities.arch.desc": "リポジトリ構造をスキャンしアーキテクチャマップを生成（arch-scan パイプライン）。",
  "settings.entities.review.name": "コードレビューア",
  "settings.entities.review.desc": "増分 / 全体コードレビューと構造化レポートの生成。",
  "settings.entities.wiki.name": "ナレッジビルダー",
  "settings.entities.wiki.desc": "コードナレッジベースとバイリンガル Wiki を構築（index build パイプライン）。",
  "settings.entities.risk.name": "リスクアナリスト",
  ...
  "editor.preview.unavailable": "このファイルはプレビューできません。",
  "editor.preview.failed": "プレビューの読み込みに失敗：{error}",
  "editor.preview.openSystem": "システムで開く",
  ...
  "editor.pair.tabAi": "AI 変更はレビュー待ち",
  "editor.pair.placeholder": "意図を一言で…（@ ファイル · # シンボル）",
  "editor.pair.send": "送信",
  "editor.pair.toChat": "会話へ",
  "editor.pair.clarify.title": "確認が必要です：",
  "editor.pair.written": "書き込み {written}/{total} 行",
  "editor.pair.step.read": "選択を理解",
  "editor.pair.step.plan": "設計",
  "editor.pair.step.write": "キャンバスへ書込",
  "editor.pair.step.verify": "検証",
  "editor.pair.ctx.selection": "選択",
  "editor.pair.ctx.lines": "行",
  "editor.pair.ctx.add": "コンテキスト",
  "editor.pair.ctx.noFiles": "他に開いているファイルはありません。",
  "editor.pair.intent.explain": "説明",
  "editor.pair.intent.explain.prompt": "このコードの責務と境界条件を説明して",
  "editor.pair.intent.refactor": "リファクタ",
  "editor.pair.intent.refactor.prompt": "リファクタ：小さい関数に分割、挙動は不変",
  "editor.pair.intent.optimize": "最適化して",
  "editor.pair.intent.optimize.prompt": "最適化して",
  "editor.head.pair": "ペア",
  "editor.head.commands": "コマンド",
  "editor.head.lane": "ペアレーン",
  "editor.pair.explain.title": "コード解説",
  "editor.pair.explain.running": "解説中…",
  "editor.pair.explain.instruction":
    "選択したコードの責務・意図・境界条件を解説してください。説明文のみを出力し、コードブロックやコードの書き換えは行わないでください。",
  "editor.pair.explain.hint": "読み取り専用の解説 — バッファは変更されません。",
  "editor.pair.lane.followup": "追記 / 追加指示…",
  "editor.ctx.pair": "インラインペア",
  "editor.ctx.explain": "選択範囲を解説",
  "editor.ctx.refactor": "選択範囲をリファクタ",
  "editor.ctx.optimize": "最適化",
  "editor.ctx.toSession": "会話へ送信",
  "editor.ctx.copy": "コピー",
  "editor.ctx.paste": "貼り付け",
  "editor.ctx.selectAll": "すべて選択",
  "editor.search.find": "検索",
  "editor.search.replace": "置換",
  "editor.search.next": "次へ",
  "editor.search.previous": "前へ",
  "editor.search.all": "すべて",
  "editor.search.matchCase": "大文字小文字を区別",
  "editor.search.regexp": "正規表現",
  "editor.search.byWord": "単語単位",
  "editor.search.replaceBtn": "置換",
  "editor.search.replaceAll": "すべて置換",
  "editor.search.close": "閉じる",
  "editor.pair.review.prevHunk": "前のハンク",
  "editor.pair.review.nextHunk": "次のハンク",
  "editor.pair.review.preview": "差分プレビュー",
  "editor.pair.review.hunkAccept": "このハンクを承認",
  "editor.pair.review.hunkReject": "このハンクを取り消す",
  "editor.pair.review.previewHint": "読み取り専用プレビュー — 承認はハンクチップで切替。",
  "taskrec.detailTime": "操作時間",
  "taskrec.detailResult": "結果",
  "editor.pair.status.branch": "git ブランチ",
  "editor.pair.cp.baseline": "ベースライン",
  "editor.pair.cp.lastSave": "最後の手動保存",
  "editor.pair.done.review": "生成完了 —— キャンバスでレビュー",
  "editor.pair.done.applied": "適用済み",
  "editor.pair.done.inCanvas": "キャンバスでレビュー",
  "editor.pair.done.rollbackHint": "⌘Z で全体をロールバック",
  "editor.pair.review.title": "AI 変更をレビュー",
  "editor.pair.review.hint": "赤 = 置換対象 · 緑 = AI 追加 · チャンクごとに ✓/✕",
  "editor.pair.review.apply": "すべて適用",
  "editor.pair.review.discard": "破棄",
  "editor.pair.status.idle": "✦ ペア待機",
  "editor.pair.status.streaming": "✦ 生成中 —— キャンバスへストリーミング",
  "editor.pair.status.review": "✦ レビュー待ち",
  "editor.pair.status.applied": "✦ 適用済み",
  "editor.pair.status.pair": "ペア",
  "editor.pair.status.palette": "コマンド",
  "editor.pair.status.rollback": "ロールバック",
  "editor.pair.status.diag": "診断",
  "editor.pair.status.diagJump": "最初の診断へ移動（行を選択しインラインペアを即開始できます）",
  "editor.pair.status.cp": "チェックポイント {n}",
  "editor.pair.cp.title": "チェックポイント",
  "editor.pair.cp.empty": "ベースライン",
  "editor.pair.cp.justNow": "たった今",
  "editor.pair.cp.minAgo": "{n} 分前",
  "editor.pair.cp.time": "{h}:{m}",
  "editor.pair.cp.hint": "⌘Z で適用済みの実行をロールバック",
  "editor.pair.cp.rollbackTo": "{label} へロールバック",
  "editor.pair.lane.title": "ペアレーン",
  "editor.pair.lane.toggle": "レーン",
  "editor.pair.lane.plan": "プラン",
  "editor.pair.lane.files": "変更ファイル",
  "editor.pair.lane.pending": "レビュー待ち",
  "editor.pair.lane.streaming": "生成中",
  "editor.pair.lane.approval": "承認キュー",
  "editor.pair.lane.approvalHint":
    "クロスファイルタスクはメインセッションから起動し、権限プロンプトは会話内でキューイングされます。",
  "editor.pair.lane.foot": "小さな編集はインラインで（⌘I）；複数ファイルはメインセッションで。",
  "editor.palette.title": "エディタパレット",
  "editor.palette.placeholder": "⌘P ファイル / ⌘T シンボル / ⇧⌘O ファイル内 — 接頭辞 @ # . で切替",
  "editor.palette.mode.files": "ファイル · インデックス",
  "editor.palette.mode.symbols": "ワークスペースシンボル · インデックス",
  "editor.palette.mode.infile": "このファイルのシンボル",
  "editor.palette.mode.cmds": "コマンド",
  "editor.palette.noIndex": "シンボルインデックスなし — ナレッジパネルで構築できます",
  "editor.palette.empty": "一致なし。",
  "editor.palette.ask": "このシンボルについてデジタルエンティティに聞く",
  "editor.palette.askPrefill": "シンボルを説明",
  "editor.palette.cmd.pair": "インラインペアを切替（⌘I）",
  "editor.palette.cmd.save": "ファイル保存（⌘S）",
  "editor.palette.cmd.explain": "AI：選択範囲を説明",
  "editor.palette.cmd.refactor": "AI：選択範囲をリファクタ",
  "editor.palette.cmd.test": "AI：選択範囲にテストを追加",
  "editor.palette.cmd.fixDiag": "AI：最初の診断を修正",
  "editor.palette.cmd.fixDiag.prompt": "この診断を修正——最小の正しい変更を提案して。",
  "editor.palette.kbd.select": "選択",
  "editor.palette.kbd.open": "開く / ジャンプ",
  ...
  "designWorkspace.noVersions": "バージョンはまだありません。",
  ...
  "designWorkspace.agent": "デザインエージェント",
  "designWorkspace.agentSilent": "サイレント実行",
  "designWorkspace.agentToggle": "デザインエージェントを切り替え",
  "designWorkspace.quickFor": "クイック操作 · {tab}",
  "designWorkspace.agentPrompt": "修正内容を入力…",
  "designWorkspace.selectionFix": "選択範囲を修正",
  "designWorkspace.selectionPrompt": "選択範囲への修正を入力…",
  "designWorkspace.executeAction": "{action} を実行",
  "designWorkspace.exportVersion": "このバージョンを書き出す",
  "designWorkspace.quoteToChat": "チャットに引用",
  "designWorkspace.previewTitle": "UI デザインプレビュー",
  "designWorkspace.exportPdf": "PDF を書き出す",
  "designWorkspace.tabPages": "ビジュアル",
  "designWorkspace.tabTokens": "デザインシステム",
  "designWorkspace.tabQuality": "品質とレビュー",
  "designWorkspace.prototypeBasis": "基盤プロトタイプ",
  "designWorkspace.designSystem": "デザインシステム",
  "designWorkspace.generateFromPrototype": "プロトタイプから生成",
  "designWorkspace.runQuality": "品質レビューを実行",
  "designWorkspace.noDesign": "特定のプロトタイプ版とデザインシステムを選んでビジュアルを生成します。",
  "designWorkspace.tokensTitle": "トークン表",
  "designWorkspace.componentsTitle": "コンポーネント原子ライブラリ",
  "designWorkspace.noTokens": "このバージョンにはトークンデータがありません。",
  "designWorkspace.noComponents": "このバージョンにはコンポーネント一覧がありません。",
  "designWorkspace.qualityTitle": "品質とレビュー",
  "designWorkspace.findings": "指摘",
  "designWorkspace.runtimeChecks": "実行時チェック",
  "designWorkspace.reviewScore": "レビュースコア",
  "designWorkspace.noQuality": "このバージョンでは品質レビューが未実行です。",
  "designWorkspace.locate": "特定",
  "designWorkspace.basedOn": "プロトタイプ {version} ベース",
  "designWorkspace.driftRun": "ドリフトチェックを実行",
  "designWorkspace.driftPass": "基準内",
  "designWorkspace.driftDetected": "ドリフトを検出",
  "designWorkspace.driftScore": "ドリフトスコア {score}",
  ...
  "designWorkspace.tokensGroup.typography": "タイポグラフィ",
  "designWorkspace.tokensGroup.spacing": "スペーシング",
  "designWorkspace.tokensGroup.radius": "角丸",
  "designWorkspace.tokensGroup.shadow": "シャドウ",
  "designWorkspace.tokensGroup.motion": "モーション",
  "designWorkspace.toastExported": "エクスポート済み：{path}",
  "designWorkspace.toastExportFailed": "エクスポート失敗：{error}",
  "designWorkspace.toastDriftDone": "ドリフトチェック完了（決定論的 0–100）",
  "designWorkspace.toastRevised": "修正を適用しました · 新バージョン作成（サイレント）",
  "designWorkspace.toastGenerated": "生成完了 · 新バージョンを追加",
  "designWorkspace.toastQualityDone": "品質レビュー完了",
  "prototypeWorkspace.setTitleSpec": "要件定義",
  "prototypeWorkspace.specHint": "一文で十分です。7 セクションの要件ドキュメントに展開されます。",
  "prototypeWorkspace.setTitleProto": "プロトタイプ",
  "prototypeWorkspace.setTitleReport": "検収レポート",
  "prototypeWorkspace.todosTitle": "未確認項目",
  "prototypeWorkspace.confirmItem": "✓ 確認",
  "prototypeWorkspace.versionCapProto": "バージョン · 1バージョン = 1セット（仕様 + プロトタイプ + レポート）",
  "prototypeWorkspace.scopeHint": "バージョン {version}",
  ...
  "prototypeWorkspace.reportHealRounds": "自己修復ラウンド（≤3）",
  "prototypeWorkspace.pendingCount": "未確認 {count} 件",
  "prototypeWorkspace.pendingCleared": "未確認項目がすべて確認されました —— 仕様が確定し、プロトタイプを生成できます。",
  "prototypeWorkspace.pendingHint": "まず未確認項目をすべて確認してください",
  "prototypeWorkspace.confirmedItem": "確認済み",
  "prototypeWorkspace.toastVerified": "受け入れチェック完了",
  ...
  "designWorkspace.atomSecondary": "副次操作",
  "designWorkspace.atomGhost": "ゴーストボタン",
  "designWorkspace.atomInput": "入力プレースホルダー",
  "designWorkspace.atomInputFocus": "フォーカス",
  "designWorkspace.atomInputError": "エラー",
  "designWorkspace.basisSwitched": "ベース原型を切り替えました · {label}",
  "designWorkspace.atomTag": "タグ",
  "designWorkspace.atomTagWarn": "警告",
  "designWorkspace.atomCardTitle": "カードタイトル",
  "designWorkspace.atomCardBody": "カード本文のサンプルテキスト。",
  "designWorkspace.triggerChainTitle": "トリガーチェーン",
  "designWorkspace.triggerChain":
    "生成と各リビジョンで design.lint（taste / anti-slop / a11y）とレンダリング後チェックを自動実行。「品質レビューを実行」で opt-in のレビューゲート（≤3 ラウンド）が追加され、結果は meta.verification に記録されます。",
  "designWorkspace.reviewRounds": "レビューラウンド",
  "designWorkspace.evidence": "証拠",
  "designWorkspace.selectionCopy": "このセクションの文言を修正",
  "designWorkspace.selectionSpacing": "余白を調整",
  "designWorkspace.quickPagesOne": "ヒーロー文言を抑制的にする",
  "designWorkspace.quickPagesTwo": "状態フィルターを追加",
  "designWorkspace.quickTokensOne": "モーショントークンの段階を追加",
  "designWorkspace.quickTokensTwo": "ダーク分岐を追加",
  "designWorkspace.quickQualityOne": "コントラストの指摘を修正",
  "designWorkspace.quickQualityTwo": "レビューゲートを再実行",
  "designWorkspace.progressGenerate": "プロトタイプからビジュアルを生成中…",
  "designWorkspace.progressSaved": "ビジュアルのバージョンを保存しました",
  "designWorkspace.progressTokensExtract": "ブランドトークンを抽出中…",
  ...
  "designWorkspace.status.ready": "準備完了",
  "designWorkspace.status.verified": "検証済み",
  "designWorkspace.vbadgeNote": "{findings} 件 · レビュー {review}",
  "designWorkspace.qualityMeta": "バージョン {version} · テーマ {theme} · 生成 {time}",
  ...
  "designWorkspace.catalog.brutalist-contrast": "ブルータリスト・コントラスト",
  "designWorkspace.catalog.swiss-international": "スイス・インターナショナル",
  "designWorkspace.catalog.terminal-mono": "ターミナル等幅",
  "designWorkspace.catalog.glass-morphism": "グラスモーフィズム",
  "designWorkspace.catalog.soft-neumorphic": "ソフトニューモーフィック",
  "designWorkspace.catalog.warm-handcrafted": "ウォームハンドクラフト",
  "prototypeWorkspace.tabSpec": "要件文書",
  "prototypeWorkspace.tabPrototype": "インタラクティブプロトタイプ",
  "prototypeWorkspace.tabReport": "受け入れ報告",
  "prototypeWorkspace.requirementPrompt": "要件を入力してください。一文でも構いません…",
  "prototypeWorkspace.generateSpec": "要件文書を生成",
  "prototypeWorkspace.materialize": "要件を確定してプロトタイプを生成",
  "prototypeWorkspace.noSpec": "まず要件文書を生成してください。",
  "prototypeWorkspace.specViewDoc": "文書",
  "prototypeWorkspace.specViewSlides": "スライド",
  "prototypeWorkspace.slidesPrev": "前のスライド",
  "prototypeWorkspace.slidesNext": "次のスライド",
  "prototypeWorkspace.slidesPage": "{current} / {total}",
  "prototypeWorkspace.slidesExportHtml": "HTML を書き出す",
  "prototypeWorkspace.slidesExportPdf": "PDF を書き出す",
  "prototypeWorkspace.slidesExported": "書き出しました：{path}",
  "prototypeWorkspace.slidesExportFailed": "書き出しに失敗：{error}",
  "prototypeWorkspace.slidesRemoteBlocked": "リモート画像 {count} 枚がオフライン安全ポリシーによりブロックされました。",
  "prototypeWorkspace.briefGenerate": "実装ブリーフを生成",
  "prototypeWorkspace.briefInject": "セッションに注入",
  "prototypeWorkspace.briefOk": "ブリーフを生成しました：{path}",
  "prototypeWorkspace.briefGaps": "ブリーフは中断 —— 未定義の画面参照があります：{gaps}",
  ...
  "prototypeWorkspace.tabArch": "技術構成",
  "prototypeWorkspace.setTitleArch": "構成",
  "prototypeWorkspace.archGenerate": "技術アーキテクチャ文書を生成",
  "prototypeWorkspace.archRegenerate": "技術アーキテクチャ文書を再生成",
  "prototypeWorkspace.archOk": "技術アーキテクチャ文書を生成しました",
  "prototypeWorkspace.archLocked": "プロトタイプの受け入れに合格すると技術アーキテクチャ文書を生成できます",
  ...
  "prototypeWorkspace.runWalkthrough": "受け入れ走査を実行",
  "prototypeWorkspace.noReport": "このバージョンでは受け入れ検証が未実行です。",
  "prototypeWorkspace.passed": "合格",
  "prototypeWorkspace.failed": "失敗",
  "prototypeWorkspace.fixFinding": "この項目を修正",
  "prototypeWorkspace.executeInstruction": "プロトタイプ action {action} を実行し、意味契約を維持する。",
  "prototypeWorkspace.selectionCopy": "この要素の文言を修正",
  "prototypeWorkspace.selectionSpacing": "この要素の余白を調整",
  "prototypeWorkspace.quickSpecOne": "受け入れ基準を追加",
  "prototypeWorkspace.quickSpecTwo": "ページ一覧を絞る",
  "prototypeWorkspace.quickProtoOne": "状態フィルターを追加",
  "prototypeWorkspace.quickProtoTwo": "コンパクトレイアウトを改善",
  ...
  "prototypeWorkspace.quickReportThree": "KPI にトレンド注記を追加",
  "prototypeWorkspace.agentWelcome":
    "修正内容をどうぞ — サイレントサブエージェントで適用し、新バージョンを作成します（メインセッションには入らない）。",
  ...
  "specs.openFailed": "spec ドキュメントを開けませんでした",
  "specs.issue.section": "構造チェック",
  "specs.issue.duplicateId": "ノード id「{id}」は既に {other} で使用されています",
  "specs.issue.unknownType": "type「{type}」は閉じた語彙集の外です",
  "specs.issue.unknownStatus": "status「{status}」は閉じた語彙集の外です",
  "specs.issue.danglingLink": "{kind} →「{id}」は存在しないノードを指しています",
  "specs.issue.independentArchitecture": "独立したアーキテクチャノード（プロダクト設計の上流なし）——合法",
  "specs.issue.archParentNotProductDesign": "parent「{parent}」は {type} ノードであり、product-design ではありません",
  "specs.issue.chainHalf": "技術設計がまだ生成されていません——正常な中間状態です",
  "specs.issue.tasksParentMismatch": "tasks の parent「{parent}」は同じディレクトリの設計ノードであるべきです",
  "specs.issue.tasksNoParent": "parent のない tasks ノード——<dir>#tasks 規約に従ってください",
  "specs.issue.artifactEscapesRoot": "artifacts エントリ「{artifact}」がワークスペースルートの外に出ています",
  "specs.issue.looseFile": "利用可能な frontmatter のない markdown ファイル——グラフノードとして未登録",
};
