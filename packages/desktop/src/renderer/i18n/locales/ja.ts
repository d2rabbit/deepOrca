...
export const ja: Record<MessageKey, string> = {
  ...
  "deck.changes.discardConfirm": "もう一度クリックで破棄",
  ...
  "deck.tree.abandonConfirm": "もう一度クリックで確認",
  ...
  "deck.sources.symbolHint": "シンボルを検索…",
  "deck.sources.noResults": "一致なし",
  "deck.sources.roleFocus": "フォーカス",
  "deck.sources.roleCallers": "呼び出し元",
  "deck.sources.roleCallees": "呼び出し先",
  "deck.sources.graphTruncated": "結果は切り詰められました",
