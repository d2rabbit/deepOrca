...
export const ja: Record<MessageKey, string> = {
  ...
  "editor.agent.title": "デジタルエンティティに質問",
  "editor.agent.ask": "選択範囲について質問",
  "editor.agent.placeholder": "この選択範囲に何をさせますか？（⌘⏎ 送信）",
  "editor.agent.hint": "会話内で実行 —— 返信は会話にストリーミングされます。",
  "editor.agent.send": "送信",
  "editor.agent.sent": "✓ 会話に送信しました",
  "editor.agent.running": "デジタルエンティティ実行中…",
  "editor.agent.apply": "選択範囲に適用",
  "editor.agent.toChat": "会話へ",
