...
export const ja: Record<MessageKey, string> = {
  ...
  "deck.placeholder.theme": "Deck テーマは E2 テーマ作業で追加されます。現在は Liquid Glass のみです。",
  "deck.placeholder.notifications": "通知はオーバーレイスタック（E3）で追加されます。",
  "deck.placeholder.e3": "このモジュールは E3 で追加されます。当面はクラシックレイアウトをご利用ください。",
};
