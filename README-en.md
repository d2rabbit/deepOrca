...
| **💻 Code**      | DeepSeek-powered conversational coding: 8 built-in tools, MCP for infinite extensibility, CodeMirror 6 editor, Git integration                           | Core Engine + MCP + CodeMirror 6                |
...
| `@deeporca/desktop`   | Electron main/preload/renderer application with CodeMirror 6, panels, and themes                   |
...
- **CodeMirror 6 editor** — professional editing with syntax highlighting, LSP completion and AI pair editing
...
| [CodeMirror 6](https://codemirror.net)                                                                                                                                                                                                                                                                                                                                                                                                                             | Code editor                                                                              | MIT                                                        |
