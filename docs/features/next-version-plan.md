...
> 日期：2026-08-18（2026-08-19 增补主线 D；2026-08-26 并入 UI/UX 概念分支，其 K 线索引知识增强改列主线 E）· 状态：**规划中（冻结期后的 `next/*` 版本路线，本文不排当前版本期）**
...
| E 索引与知识增强（K 线，2026-08-20 立项） | K1 对抗证伪审查 + K2a 检索预算观测（P0）；K2b 设计先行 | K2a P1 干预（基线数据拍板后） |
...
## 主线 E：索引与知识增强（K 线，2026-08-20 立项；并入自 UI/UX 概念分支，与 D 线正交）
