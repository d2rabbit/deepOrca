...
>
> **架构图构建（2026-08-06 决策）**：不采纳 [oh-my-mermaid](https://github.com/oh-my-mermaid/oh-my-mermaid)（omm，AI 驱动的 Mermaid 架构文档生成器）—— 与 DeepOrca 现有能力重叠且引入成本高。**架构图/架构探索改用 A2UI 承载**：自建 skill 借鉴 omm 的多视角/递归 prompt 思路，渲染用 A2UI 组件树（可嵌套、可联动代码）替代静态 Mermaid + web viewer。调研详见 `docs/research/2026-08-06-oh-my-mermaid-research.md`。
