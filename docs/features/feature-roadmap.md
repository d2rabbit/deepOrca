...
| [二、知识中心](#二知识中心)                       | openwiki（Wiki）, **@deeporca/memory**（TDAI L0–L3 持久化记忆）, activity-frames（行为记忆）, **GitMCP 本地化模块**（8 工具） | Open Deep Research 理念, **索引与知识增强 K 线（下一版主线 D，2026-08-20 立项）**                                                                                                                                                          | 项目文档 + 跨会话记忆 + 行为记忆 + 深度研究              |
