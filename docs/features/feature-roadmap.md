...
当前问题：每个能力各自是独立 MCP server，工具列表随能力增多而膨胀（codegraph_explore / a2ui_render_surface / crg_analyze / dart_mcp_… → 50+ 工具平铺给 LLM）。LLM 需要知道所有工具名才能调用，认知负担随工具数线性增长。
