...
const I18N = {
  zh: {
    ...
    "depth.pillars": "−50m · 浅海猎场",
    "depth.modules": "−300m · 洋流层",
    "depth.extend": "−500m · 群猎协作",
    "depth.gallery": "−650m · 猎场实录",
    "depth.roadmap": "−900m · 下潜航线",
    "depth.boot": "−1000m · 深渊营地",
    "pillars.d1": "浅海 · 声呐侦察",
    "pillars.d2": "中层 · 协作围猎",
    "pillars.d3": "深渊 · 致命一击",
    "pillars.tag": "✦ 三大核心能力",
  ...
  en: {
    ...
    "depth.pillars": "−50m · The Shallows",
    "depth.modules": "−300m · The Current",
    "depth.extend": "−500m · Pod Hunt",
    "depth.gallery": "−650m · Hunt Records",
    "depth.roadmap": "−900m · Dive Route",
    "depth.boot": "−1000m · Abyss Camp",
    "pillars.d1": "Shallows · Sonar Scout",
    "pillars.d2": "Midwater · Carousel Hunt",
    "pillars.d3": "Abyss · The Final Strike",
...
(function orcaHunt() {
  ...
  // refined artwork: orca courtesy of the studio palette, blue whale derived kin
  const ORCA_SRC = "assets/orca-detailed.svg";
  const WHALE_SRC = "assets/blue-whale.svg";
