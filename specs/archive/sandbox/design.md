...
> **✅ 已归档（2026-09-03 用户拍板）**——P0–P2 主体 40/45 收官（macOS 后端/审计/隔离器/quarantine/路径授权落地）；5 项未决项（bwrap / WSL2 / 能力矩阵对账 / 任务 20 / 任务 21）整体延伸为独立任务规划 [`specs/sandbox-next/`](../../next-version/sandbox-next/design.md)。
>
 ...
 * "仅 projectRoot"，即 fail-closed。派生算法见 specs/archive/sandbox/design.md §4.1。
 */
pathGrant?: PathGrant;
```
