...
> **✅ 已归档（2026-09-03 用户拍板）**——G1/G2/M4/R1-R4 + 目标表 G3 分片召回全部落地，无未决项。
>
...
| M4   | **已完成** SAD 分解 + 兼容性规划 + DAG 组合（SkillWeaver Decompose-Retrieve-Compose） | 单测 28/28，SAD 收敛 + Composer Eq.4 + DAG 依赖检测 |
