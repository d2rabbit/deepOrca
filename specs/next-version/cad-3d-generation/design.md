...
> 关联路线：feature-roadmap §十八 3D 与制造（新增）、§六 设计生成、§十六 能力编排（defineAction）、§十二 插件中心（SkillSpector 闸门）、PM-Design V2 管线路由（`specs/archive/design-systems-advance/pm-design-v2-design.md`）
>
> 设计约束：
>
...
PM-Design V2 的统一路由（`specs/archive/design-systems-advance/pm-design-v2-design.md`）新增第 4 条管线：
...
> 任务清单已抽离至 [`tasks.md`](./tasks.md)（2026-08-18 文档整顿：P0 图片转 3D MVP / P1 CAD 核心闭环 / P2 扩展能力，含验收标准与开工前置条件）。
