...
> **2026-09-03 并入 [design-systems-advance](./design.md)**（用户拍板，以后者为主）——本文作为已实现前置工件保留于该目录；原 `specs/pm-design-v2/` 目录撤销。
> **日期**：2026-08-11
...
| 任务 | 交付 |
| --- | --- |
| 编写本设计文档 | `specs/design-systems-advance/pm-design-v2-design.md` |
| 编写任务分解 | `specs/design-systems-advance/pm-design-v2-tasks.md` |
